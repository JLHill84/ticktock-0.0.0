    ...
    !function (undef) {
        ...
        function normalize(name, baseName) {
            ...
            if (name && "." === name.charAt(0))
                if (baseName) {
                    for (baseParts = baseParts.slice(0, baseParts.length - 1),
                        name = name.split("/"),
        ...
        function () {
            ...
            function compareAscending(a, b) {
                for (var ac = a.criteria, bc = b.criteria, index = -1, length = ac.length; ++index < length;) {
                    var value = ac[index]
                        , other = bc[index];
                    if (value !== other) {
                        if (value > other || "undefined" == typeof value)
                            return 1;
                        if (other > value || "undefined" == typeof other)
                            return -1
                    }
                }
            ...
            function createCache(array) {
                var index = -1
                    ...
                    , last = array[length - 1];
                if (first && "object" == typeof first && mid && "object" == typeof mid && last && "object" == typeof last)
                    return !1;
                var cache = getObject();
                cache["false"] = cache["null"] = cache["true"] = cache.undefined = !1;
                var result = getObject();
                for (result.array = array,
                    result.cache = cache,
                    result.push = cachePush; ++index < length;)
            ...
            function slice(array, start, end) {
                ...
                for (var index = -1, length = end - start || 0, result = Array(0 > length ? 0 : length); ++index < length;)
            ...
            function runInContext(context) {
                ...
                function baseClone(value, isDeep, callback, stackA, stackB) {
                    ...
                    return isArr && (hasOwnProperty.call(value, "index") && (result.index = value.index),
                        ...
                        isDeep ? (stackA.push(value),
                            stackB.push(result),
                            (isArr ? baseEach : forOwn)(value, function (objValue, key) {
                                result[key] = baseClone(objValue, isDeep, callback, stackA, stackB)
                            }),
                            initedStack && (releaseArray(stackA),
                                releaseArray(stackB)),
                            result) : result
                }
                ...
                function baseCreateCallback(func, thisArg, argCount) {
                    ...
                    if ("undefined" == typeof bindData && (support.funcNames && (bindData = !func.name),
                        ...
                        support.funcNames || (bindData = !reFuncName.test(source)),
                            bindData || (bindData = reThis.test(source),
                                setBindData(func, bindData))
                    }
                    if (bindData === !1 || bindData !== !0 && 1 & bindData[1])
                        return func;
                    switch (argCount) {
                        case 1:
                            return function (value) {
                ...
                function baseCreateWrapper(bindData) {
                    function bound() {
                        ...
                        if ((partialRightArgs || isCurry) && (args || (args = slice(arguments)),
                ...
                function baseIsEqual(a, b, callback, isWhere, stackA, stackB) {
                    ...
                    if (result = !0,
                        ...
                        forIn(b, function (value, key, b) {
                            return hasOwnProperty.call(b, key) ? (size++,
                                result = hasOwnProperty.call(a, key) && baseIsEqual(a[key], value, callback, isWhere, stackA, stackB)) : void 0
                        }),
                ...
                function baseMerge(object, source, callback, stackA, stackB) {
                    (isArray(source) ? forEach : forOwn)(source, function (source, key) {
                        ...
                        if (source && ((isArr = isArray(source)) || isPlainObject(source))) {
                            ...
                            if (!found) {
                                var isShallow;
                                callback && (result = callback(value, source),
                ...
                function baseUniq(array, isSorted, callback) {
                    ...
                    return isLarge ? (releaseArray(seen.array),
                        releaseObject(seen)) : callback && releaseArray(seen),
                        result
                }
                function createAggregator(setter) {
                    return function (collection, callback, thisArg) {
                        var result = {};
                        if (callback = lodash.createCallback(callback, thisArg, 3),
                            isArray(collection))
                ...
                function createWrapper(func, bitmask, partialArgs, partialRightArgs, thisArg, arity) {
                    ...
                    if (!isBindKey && !isFunction(func))
                        throw new TypeError;
                    isPartial && !partialArgs.length && (bitmask &= -17,
                        isPartial = partialArgs = !1),
                        isPartialRight && !partialRightArgs.length && (bitmask &= -33,
                            isPartialRight = partialRightArgs = !1);
                    var bindData = func && func.__bindData__;
                    if (bindData && bindData !== !0)
                        return bindData = slice(bindData),
                ...
                function shimIsPlainObject(value) {
                    ...
                    return !value || toString.call(value) != objectClass || (ctor = value.constructor,
                        isFunction(ctor) && !(ctor instanceof ctor)) || !support.argsClass && isArguments(value) || !support.nodeClass && isNode(value) ? !1 : support.ownLast ? (forIn(value, function (value, key, object) {
                            return result = hasOwnProperty.call(object, key),
                                !1
                        }),
                ...
                function clone(value, isDeep, callback, thisArg) {
                    return "boolean" != typeof isDeep && null != isDeep && (thisArg = callback,
                        callback = isDeep,
                        isDeep = !1),
                ...
                function findKey(object, callback, thisArg) {
                    ...
                    return callback = lodash.createCallback(callback, thisArg, 3),
                        forOwn(object, function (value, key, object) {
                            return callback(value, key, object) ? (result = key,
                                !1) : void 0
                        }),
                        result
                }
                ...
                function forOwnRight(object, callback, thisArg) {
                    ...
                    for (callback = baseCreateCallback(callback, thisArg, 3); length--;) {
                        ...
                        if (callback(object[key], key, object) === !1)
                            break
                    }
                    return object
                }
                ...
                function merge(object) {
                    ...
                    if (!isObject(object))
                        return object;
                    if ("number" != typeof args[2] && (length = args.length),
                        length > 3 && "function" == typeof args[length - 2])
                        var callback = baseCreateCallback(args[--length - 1], args[length--], 2);
                    else
                        length > 2 && "function" == typeof args[length - 1] && (callback = args[--length]);
                    for (var sources = slice(arguments, 1, length), index = -1, stackA = getArray(), stackB = getArray(); ++index < length;)
                ...
                function transform(object, callback, accumulator, thisArg) {
                    ...
                    return callback && (callback = lodash.createCallback(callback, thisArg, 4),
                ...
                function at(collection) {
                    var args = arguments
                        , index = -1
                        , props = baseFlatten(args, !0, !1, 1)
                        , length = args[2] && args[2][args[1]] === collection ? 1 : props.length
                        , result = Array(length);
                    for (support.unindexedChars && isString(collection) && (collection = collection.split("")); ++index < length;)
                ...
                function every(collection, callback, thisArg) {
                    ...
                    if (callback = lodash.createCallback(callback, thisArg, 3),
                        isArray(collection))
                        for (var index = -1, length = collection.length; ++index < length && (result = !!callback(collection[index], index, collection));)
                            ;
                    else
                ...
                function find(collection, callback, thisArg) {
                    if (callback = lodash.createCallback(callback, thisArg, 3),
                        ...
                        return baseEach(collection, function (value, index, collection) {
                            return callback(value, index, collection) ? (result = value,
                                !1) : void 0
                        }),
                            result
                    }
                ...
                function forEach(collection, callback, thisArg) {
                    if (callback && "undefined" == typeof thisArg && isArray(collection))
                        for (var index = -1, length = collection.length; ++index < length && callback(collection[index], index, collection) !== !1;)
                            ;
                    else
                ...
                function forEachRight(collection, callback, thisArg) {
                    ...
                    if (callback = callback && "undefined" == typeof thisArg ? callback : baseCreateCallback(callback, thisArg, 3),
                        ...
                        if ("number" != typeof length) {
                            ...
                            support.unindexedChars && isString(collection) && (iterable = collection.split(""));
                        baseEach(collection, function (value, key, collection) {
                            return key = props ? props[--length] : --length,
                                callback(iterable[key], key, collection)
                        })
                    }
                    return collection
                }
                ...
                function max(collection, callback, thisArg) {
                    ...
                    if ("function" != typeof callback && thisArg && thisArg[callback] === collection && (callback = null),
                        null == callback && isArray(collection))
                        for (var index = -1, length = collection.length; ++index < length;) {
                            var value = collection[index];
                        ...
                        callback = null == callback && isString(collection) ? charAtCallback : lodash.createCallback(callback, thisArg, 3),
                            baseEach(collection, function (value, index, collection) {
                                ...
                                current > computed && (computed = current,
                                    result = value)
                            });
                    return result
                }
                ...
                function reduce(collection, callback, accumulator, thisArg) {
                    ...
                    if (callback = lodash.createCallback(callback, thisArg, 4),
                        isArray(collection)) {
                        var index = -1
                            , length = collection.length;
                        for (noaccum && (accumulator = collection[++index]); ++index < length;)
                            accumulator = callback(accumulator, collection[index], index, collection)
                    } else
                        baseEach(collection, function (value, index, collection) {
                            accumulator = noaccum ? (noaccum = !1,
                                value) : callback(accumulator, value, index, collection)
                        });
                    return accumulator
                }
                ...
                function reject(collection, callback, thisArg) {
                    return callback = lodash.createCallback(callback, thisArg, 3),
                        filter(collection, function (value, index, collection) {
                ...
                function sortBy(collection, callback, thisArg) {
                    var index = -1
                        ...
                        , length = collection ? collection.length : 0
                        , result = Array("number" == typeof length ? length : 0);
                    for (isArr || (callback = lodash.createCallback(callback, thisArg, 3)),
                        ...
                        result.sort(compareAscending); length--;) {
                ...
                function first(array, callback, thisArg) {
                    ...
                    if ("number" != typeof callback && null != callback) {
                        var index = -1;
                        for (callback = lodash.createCallback(callback, thisArg, 3); ++index < length && callback(array[index], index, array);)
                            n++
                    } else if (n = callback,
                        null == n || thisArg)
                ...
                function initial(array, callback, thisArg) {
                    ...
                    if ("number" != typeof callback && null != callback) {
                        var index = length;
                        for (callback = lodash.createCallback(callback, thisArg, 3); index-- && callback(array[index], index, array);)
                            n++
                    } else
                    ...
                    outer: for (; ++index < length;) {
                        ...
                        if (value = array[index],
                            ...
                            for (argsIndex = argsLength,
                                (cache || seen).push(value); --argsIndex;)
                                if (cache = caches[argsIndex],
                ...
                function pull(array) {
                    for (var args = arguments, argsIndex = 0, argsLength = args.length, length = array ? array.length : 0; ++argsIndex < argsLength;)
                        for (var index = -1, value = args[argsIndex]; ++index < length;)
                            array[index] === value && (splice.call(array, index--, 1),
                                length--);
                    return array
                }
                function range(start, end, step) {
                    start = +start || 0,
                        ...
                        null == end && (end = start,
                            start = 0);
                    for (var index = -1, length = nativeMax(0, ceil((end - start) / (step || 1))), result = Array(length); ++index < length;)
                        result[index] = start,
                            start += step;
                    return result
                }
                function remove(array, callback, thisArg) {
                    ...
                    for (callback = lodash.createCallback(callback, thisArg, 3); ++index < length;) {
                        var value = array[index];
                        callback(value, index, array) && (result.push(value),
                ...
                function rest(array, callback, thisArg) {
                    if ("number" != typeof callback && null != callback) {
                        ...
                        n = null == callback || thisArg ? 1 : nativeMax(0, callback);
                ...
                function zip() {
                    for (var array = arguments.length > 1 ? arguments : arguments[0], index = -1, length = array ? max(pluck(array, "length")) : 0, result = Array(0 > length ? 0 : length); ++index < length;)
                ...
                function compose() {
                    for (var funcs = arguments, length = funcs.length; length--;)
                        if (!isFunction(funcs[length]))
                            throw new TypeError;
                    return function () {
                        for (var args = arguments, length = funcs.length; length--;)
                    ...
                    var delayed = function () {
                        ...
                        , maxDelayed = function () {
                            timeoutId && clearTimeout(timeoutId),
                                maxTimeoutId = timeoutId = trailingCall = undefined,
                                (trailing || maxWait !== wait) && (lastCalled = now(),
                                    result = func.apply(thisArg, args),
                                    timeoutId || maxTimeoutId || (args = thisArg = null))
                        };
                    return function () {
                ...
                function random(min, max, floating) {
                    var noMin = null == min
                        , noMax = null == max;
                    if (null == floating && ("boolean" == typeof min && noMax ? (floating = min,
                        min = 1) : noMax || "boolean" != typeof max || (floating = max,
                            noMax = !0)),
                        noMin && noMax && (max = 1),
                        min = +min || 0,
                        noMax ? (max = min,
                ...
                function template(text, data, options) {
                    ...
                    return data ? result(data) : (result.source = source,
                        result)
                }
                function times(n, callback, thisArg) {
                    ...
                    var index = -1
                        , result = Array(n);
                    for (callback = baseCreateCallback(callback, thisArg, 1); ++index < n;)
                    ...
                    !function () {
                        for (var length = shadowedProps.length; length--;) {
                            ...
                            for (var className in nonEnumProps)
                                hasOwnProperty.call(nonEnumProps, className) && !hasOwnProperty.call(nonEnumProps[className], key) && (nonEnumProps[className][key] = !1)
                        }
                    }(),
                ...
                !function () {
                    ...
                    support.argsClass = toString.call(arguments) == argsClass,
                        ...
                        support.spliceObjects = (arrayRef.splice.call(object, 0, 1),
                            !object[0]),
                ...
                var isArray = nativeIsArray || function (value) {
                    ...
                    , defaults = createIterator(defaultsIteratorOptions)
                ...
                var isPlainObject = getPrototypeOf ? function (value) {
                    ...
                    , pluck = map
                    , where = filter
                    , now = isNative(now = Date.now) && now || function () {
                ...
                return lodash.after = after,
                    ...
                    support.spliceObjects || baseEach(["pop", "shift", "splice"], function (methodName) {
                        var func = arrayRef[methodName]
                            , isSplice = "splice" == methodName;
                        lodash.prototype[methodName] = function () {
                            var chainAll = this.__chain__
                                , value = this.__wrapped__
                                , result = func.apply(value, arguments);
                            return 0 === value.length && delete value[0],
                                chainAll || isSplice ? new lodashWrapper(result, chainAll) : result
                        }
                    }),
                    lodash
            }
        ...
        !function (window, undefined) {
            ...
            function internalData(elem, name, data, pvt) {
                if (jQuery.acceptData(elem)) {
                    ...
                    if (id && cache[id] && (pvt || cache[id].data) || data !== undefined || "string" != typeof name)
            ...
            function css_defaultDisplay(nodeName) {
                ...
                return display || (display = actualDisplay(nodeName, doc),
                    "none" !== display && display || (iframe = (iframe || jQuery("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(doc.documentElement),
                ...
                jQuery.extend({
                    ...
                    proxy: function (fn, context) {
                        ...
                        return "string" == typeof context && (tmp = fn[context],
                            context = fn,
                            fn = tmp),
                            jQuery.isFunction(fn) ? (args = core_slice.call(arguments, 2),
                                proxy = function () {
                ...
                !function (window, undefined) {
                                        ...
                                        if (1 === elem.nodeType || checkNonElements)
                                            if (outerCache = elem[expando] || (elem[expando] = {}),
                                                ...
                                                if ((data = cache[1]) === !0 || data === cachedruns)
                                                    return data === !0
                                            } else if (cache = outerCache[dir] = [dirkey],
                    ...
                    function matcherFromGroupMatchers(elementMatchers, setMatchers) {
                        var matcherCachedRuns = 0
                            ...
                            , superMatcher = function (seed, context, xml, results, expandContext) {
                                ...
                                for (outermost && (outermostContext = context !== document && context,
                                    cachedruns = matcherCachedRuns); null != (elem = elems[i]); i++) {
                                    if (byElement && elem) {
                                ...
                                ATTR: function (name, operator, check) {
                                    return function (elem) {
                                        ...
                                        return null == result ? "!=" === operator : operator ? (result += "",
                                            "=" === operator ? result === check : "!=" === operator ? result !== check : "^=" === operator ? check && 0 === result.indexOf(check) : "*=" === operator ? check && result.indexOf(check) > -1 : "$=" === operator ? check && result.slice(-check.length) === check : "~=" === operator ? (" " + result + " ").indexOf(check) > -1 : "|=" === operator ? result === check || result.slice(0, check.length + 1) === check + "-" : !1) : !0
                                    }
                                },
                    ...
                    setFilters.prototype = Expr.filters = Expr.pseudos,
                        ...
                        compile = Sizzle.compile = function (selector, group) {
                            ...
                            if (!cached) {
                                for (group || (group = tokenize(selector)),
                                    i = group.length; i--;)
            ...
            jQuery.Callbacks = function (options) {
                ...
                jQuery.support = function (support) {
                    ...
                    if (div.setAttribute("className", "t"),
                        div.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
                        all = div.getElementsByTagName("*") || [],
                        a = div.getElementsByTagName("a")[0],
                        !a || !a.style || !all.length)
                        return support;
                    ...
                    return support.ownLast = "0" !== i,
                        jQuery(function () {
                            ...
                            body && (container = document.createElement("div"),
                                ...
                                typeof div.style.zoom !== core_strundefined && (div.innerHTML = "",
            ...
            jQuery.fn.extend({
                ...
                toggleClass: function (value, stateVal) {
                    ...
                    return "boolean" == typeof stateVal && "string" === type ? stateVal ? this.addClass(value) : this.removeClass(value) : jQuery.isFunction(value) ? this.each(function (i) {
                        ...
                        if ("string" === type)
                            for (var className, i = 0, self = jQuery(this), classNames = value.match(core_rnotwhite) || []; className = classNames[i++];)
                                self.hasClass(className) ? self.removeClass(className) : self.addClass(className);
                        else
                            (type === core_strundefined || "boolean" === type) && (this.className && jQuery._data(this, "__className__", this.className),
                ...
                jQuery.extend({
                    ...
                    attr: function (elem, name, value) {
                        ...
                        if (elem && 3 !== nType && 8 !== nType && 2 !== nType) {
                            ...
                            if (1 === nType && jQuery.isXMLDoc(elem) || (name = name.toLowerCase(),
                                hooks = jQuery.attrHooks[name] || (jQuery.expr.match.bool.test(name) ? boolHook : nodeHook)),
                                value === undefined)
                                return hooks && "get" in hooks && null !== (ret = hooks.get(elem, name)) ? ret : (ret = jQuery.find.attr(elem, name),
                                    null == ret ? undefined : ret);
                            if (null !== value)
                                return hooks && "set" in hooks && (ret = hooks.set(elem, value, name)) !== undefined ? ret : (elem.setAttribute(name, value + ""),
                                    value);
            ...
            jQuery.event = {
                ...
                remove: function (elem, types, handler, selector, mappedTypes) {
                    ...
                    if (elemData && (events = elemData.events)) {
                        for (types = (types || "").match(core_rnotwhite) || [""],
                            t = types.length; t--;)
                        ...
                        for (handlerQueue = jQuery.event.handlers.call(this, event, handlers),
                            ...
                            for (event.currentTarget = matched.elem,
                                ...
                                (!event.namespace_re || event.namespace_re.test(handleObj.namespace)) && (event.handleObj = handleObj,
                                    ...
                                    ret !== undefined && (event.result = ret) === !1 && (event.preventDefault(),
                ...
                jQuery.Event = function (src, props) {
                    return this instanceof jQuery.Event ? (src && src.type ? (this.originalEvent = src,
                        this.type = src.type,
                        this.isDefaultPrevented = src.defaultPrevented || src.returnValue === !1 || src.getPreventDefault && src.getPreventDefault() ? returnTrue : returnFalse) : this.type = src,
                ...
                jQuery.fn.extend({
                    ...
                    replaceWith: function () {
                        ...
                        return this.domManip(arguments, function (elem) {
                            var next = args[i++]
                                , parent = args[i++];
                            parent && (next && next.parentNode !== parent && (next = this.nextSibling),
                                jQuery(this).remove(),
                ...
                jQuery.extend({
                    clone: function (elem, dataAndEvents, deepDataAndEvents) {
                        ...
                        if (jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test("<" + elem.nodeName + ">") ? clone = elem.cloneNode(!0) : (fragmentDiv.innerHTML = elem.outerHTML,
                            ...
                            !(jQuery.support.noCloneEvent && jQuery.support.noCloneChecked || 1 !== elem.nodeType && 11 !== elem.nodeType || jQuery.isXMLDoc(elem)))
                        ...
                        if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                            ...
                            if (type = typeof value,
                                "string" === type && (ret = rrelNum.exec(value)) && (value = (ret[1] + 1) * ret[2] + parseFloat(jQuery.css(elem, name)),
                                    type = "number"),
                                !(null == value || "number" === type && isNaN(value) || ("number" !== type || jQuery.cssNumber[origName] || (value += "px"),
                                    jQuery.support.clearCloneStyle || "" !== value || 0 !== name.indexOf("background") || (style[name] = "inherit"),
                                    hooks && "set" in hooks && (value = hooks.set(elem, value, extra)) === undefined)))
                                try {
                                    style[name] = value
                                } catch (e) { }
                        }
            ...
            ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [],
                jQuery.fn.load = function (url, params, callback) {
                    ...
                    return off >= 0 && (selector = url.slice(off, url.length),
                        url = url.slice(0, off)),
                    ...
                    ajax: function (url, options) {
                        ...
                        fireGlobals = s.global,
                            ...
                            s.hasContent || (s.data && (cacheURL = s.url += (ajax_rquery.test(cacheURL) ? "&" : "?") + s.data,
                                delete s.data),
                                s.cache === !1 && (s.url = rts.test(cacheURL) ? cacheURL.replace(rts, "$1_=" + ajax_nonce++) : cacheURL + (ajax_rquery.test(cacheURL) ? "&" : "?") + "_=" + ajax_nonce++)),
                        ...
                        return {
                            send: function (headers, complete) {
                                ...
                                xhr.send(s.hasContent && s.data || null),
                                        ...
                                        try {
                                            if (callback && (isAbort || 4 === xhr.readyState))
                                                if (callback = undefined,
                                                    handle && (xhr.onreadystatechange = jQuery.noop,
                                    ...
                                    ,
                                    s.async ? 4 === xhr.readyState ? setTimeout(callback) : (handle = ++xhrId,
                                        xhrOnUnloadAbort && (xhrCallbacks || (xhrCallbacks = {},
                                            jQuery(window).unload(xhrOnUnloadAbort)),
                                            xhrCallbacks[handle] = callback),
                                        xhr.onreadystatechange = callback) : callback()
                            },
                            abort: function () {
            ...
            jQuery.Animation = jQuery.extend(Animation, {
                ...
                jQuery.fn.offset = function (options) {
                    ...
                    return doc ? (docElem = doc.documentElement,
                        jQuery.contains(docElem, elem) ? (typeof elem.getBoundingClientRect !== core_strundefined && (box = elem.getBoundingClientRect()),
                            win = getWindow(doc),
                        {
                ...
                "object" == typeof module && module && "object" == typeof module.exports ? module.exports = jQuery : (window.jQuery = window.$ = jQuery,
                    "function" == typeof define && define.amd && define("jquery", [], function () {
                        return jQuery
                    }))
        }(window),
        define("jqueryPrivate", ["jquery"], function ($) {
            return $.noConflict()
        }),
        function () {
            ...
            _.extend(Collection.prototype, Events, {
                ...
                set: function (models, options) {
                    ...
                    for (i = 0,
                        l = models.length; l > i; i++) {
                        if (attrs = models[i],
                            id = attrs instanceof Model ? model = attrs : attrs[targetModel.prototype.idAttribute],
                            existing = this.get(id))
                            remove && (modelMap[existing.cid] = !0),
                                merge && (attrs = attrs === model ? model.attributes : attrs,
                ...
                get: function (obj) {
                    return null != obj ? this._byId[obj.id] || this._byId[obj.cid] || this._byId[obj] : void 0
                },
                at: function (index) {
            ...
            History.started = !1,
                _.extend(History.prototype, Events, {
                    ...
                    loadUrl: function (fragment) {
                        return fragment = this.fragment = this.getFragment(fragment),
                    ...
                    navigate: function (fragment, options) {
                        ...
                        if (fragment = fragment.replace(pathStripper, ""),
                            this.fragment !== fragment) {
        ...
        define("constants", [], function () {
            var constants = {};
            return constants.APPLICATION_CHANNEL = "App",
                constants.ATTR_DELIMITER = ",",
                constants.ATTR_NAMESPACE = "sm",
                constants.DATA = "data",
                constants.DATA_DELIMITER = "-",
                constants.DATA_ELEMENT = "el",
                constants.INIT_METHOD = "init",
                constants.INSTANCE = "instance",
                constants.INSTANCE_AS = " as ",
                constants.MODULE = "module",
                constants.MODULE_PATH = "modules",
                constants.PATH_DELIMITER = "/",
                constants.STRUCTURE_ID = "structure-id",
                constants.STRUCTURE_CONFIG = "config",
                constants.STRUCTURE_ROOT = "_root",
                constants.TOPIC_DELIMITER = ".",
                constants
        }),
        !function (root, factory) {
            "object" == typeof module && module.exports ? module.exports = function (_) {
                return _ = _ || require("underscore"),
                    factory(_)
            }
                : "function" == typeof define && define.amd ? define("postal", ["underscore"], function (_) {
                    return factory(_, root)
                }) : root.postal = factory(root._, root)
        }(this, function (_, global, undefined) {
            var postal, ConsecutiveDistinctPredicate = function () {
                var previous;
                return function (data) {
                    var eq = !1;
                    return _.isString(data) ? (eq = data === previous,
                        previous = data) : (eq = _.isEqual(data, previous),
                            previous = _.clone(data)),
                        !eq
                }
            }, DistinctPredicate = function () {
                var previous = [];
                return function (data) {
                    var isDistinct = !_.any(previous, function (p) {
                        return _.isObject(data) || _.isArray(data) ? _.isEqual(data, p) : data === p
                    });
                    return isDistinct && previous.push(data),
                        isDistinct
                }
            }, ChannelDefinition = function (channelName) {
                this.channel = channelName || postal.configuration.DEFAULT_CHANNEL
            };
            ChannelDefinition.prototype.subscribe = function () {
                return 1 === arguments.length ? new SubscriptionDefinition(this.channel, arguments[0].topic, arguments[0].callback) : new SubscriptionDefinition(this.channel, arguments[0], arguments[1])
            }
                ,
                ChannelDefinition.prototype.publish = function () {
                    var envelope = 1 === arguments.length ? "[object String]" === Object.prototype.toString.call(arguments[0]) ? {
                        topic: arguments[0]
                    } : arguments[0] : {
                        topic: arguments[0],
                        data: arguments[1]
                    };
                    return envelope.channel = this.channel,
            ...
            SubscriptionDefinition.prototype = {
                ...
                defer: function () {
                    var self = this
                        , fn = this.callback;
                    return this.callback = function (data, env) {
                        setTimeout(function () {
                ...
                disposeAfter: function (maxCalls) {
                    if (_.isNaN(maxCalls) || 0 >= maxCalls)
                        throw "The value provided to disposeAfter (maxCalls) must be a number greater than zero.";
                    var self = this
                        , fn = this.callback
                        , dispose = _.after(maxCalls, _.bind(function () {
                            this.unsubscribe()
                        }, this));
                ...
                withConstraint: function (predicate) {
                    ...
                    return this.constraints.push(predicate),
                        this
                },
                withConstraints: function (predicates) {
                    var self = this;
                    return _.isArray(predicates) && _.each(predicates, function (predicate) {
                ...
                withDebounce: function (milliseconds, immediate) {
                    ...
                    return this.callback = _.debounce(fn, milliseconds, !!immediate),
                        this
                },
                ...
                withThrottle: function (milliseconds) {
                    if (_.isNaN(milliseconds))
                        throw "Milliseconds must be a number";
                    var fn = this.callback;
                    return this.callback = _.throttle(fn, milliseconds),
                        this
                },
            ...
            var bindingsResolver = {
                ...
                compare: function (binding, topic) {
                    ...
                    return "undefined" != typeof result ? result : ((rgx = this.regex[binding]) || (pattern = "^" + _.map(binding.split("."), function (segment) {
                        var res = "";
                        return prevSegment && (res = "#" !== prevSegment ? "\\.\\b" : "\\b"),
                            res += "#" === segment ? "[\\s\\S]*" : "*" === segment ? "[^.]+" : segment,
                            prevSegment = segment,
                            res
                    }).join("") + "$",
                ...
                , fireSub = function (subDef, envelope) {
                    !subDef.inactive && postal.configuration.resolver.compare(subDef.topic, envelope.topic) && _.all(subDef.constraints, function (constraint) {
                        return constraint.call(subDef.context, envelope.data, envelope)
                    }) && "function" == typeof subDef.callback && subDef.callback.call(subDef.context, envelope.data, envelope)
                }
                , pubInProgress = 0
                , unSubQueue = []
                , clearUnSubQueue = function () {
                    for (; unSubQueue.length;)
                        localBus.unsubscribe(unSubQueue.shift())
                }
                , localBus = {
                    addWireTap: function (callback) {
                        var self = this;
                        return self.wireTaps.push(callback),
                            function () {
                                var idx = self.wireTaps.indexOf(callback);
                                -1 !== idx && self.wireTaps.splice(idx, 1)
                            }
                    },
                    publish: function (envelope) {
                        return ++pubInProgress,
                            envelope.timeStamp = new Date,
                            _.each(this.wireTaps, function (tap) {
                                tap(envelope.data, envelope)
                            }),
                            this.subscriptions[envelope.channel] && _.each(this.subscriptions[envelope.channel], function (subscribers) {
                                for (var subDef, idx = 0, len = subscribers.length; len > idx;)
                                    (subDef = subscribers[idx++]) && fireSub(subDef, envelope)
                            }),
                            0 === --pubInProgress && clearUnSubQueue(),
                            envelope
                    },
                    reset: function () {
                        this.subscriptions && (_.each(this.subscriptions, function (channel) {
                    ...
                    subscribe: function (subDef) {
                        var subs, channel = this.subscriptions[subDef.channel];
                        return channel || (channel = this.subscriptions[subDef.channel] = {}),
                            subs = this.subscriptions[subDef.channel][subDef.topic],
                            subs || (subs = this.subscriptions[subDef.channel][subDef.topic] = []),
                            subs.push(subDef),
                            subDef
                    },
                    subscriptions: {},
                    ...
                    unsubscribe: function (config) {
                        ...
                        else if (this.subscriptions[config.channel][config.topic])
                            for (var len = this.subscriptions[config.channel][config.topic].length, idx = 0; len > idx;) {
            ...
            if (postal = {
                ...
                publish: function (envelope) {
                    return envelope.channel = envelope.channel || postal.configuration.DEFAULT_CHANNEL,
                        postal.configuration.bus.publish(envelope)
                },
                addWireTap: function (callback) {
                ...
                linkChannels: function (sources, destinations) {
                    var result = [];
                    return sources = _.isArray(sources) ? sources : [sources],
                ...
                utils: {
                    getSubscribersFor: function () {
                        var channel = arguments[0]
                            , tpc = arguments[1];
                        return 1 === arguments.length && (channel = arguments[0].channel || postal.configuration.DEFAULT_CHANNEL,
                            tpc = arguments[0].topic),
                            postal.configuration.bus.subscriptions[channel] && Object.prototype.hasOwnProperty.call(postal.configuration.bus.subscriptions[channel], tpc) ? postal.configuration.bus.subscriptions[channel][tpc] : []
                    },
                    reset: function () {
                ...
                global && Object.prototype.hasOwnProperty.call(global, "__postalReady__") && _.isArray(global.__postalReady__))
                for (; global.__postalReady__.length;)
                    global.__postalReady__.shift().onReady(postal);
            return postal
        }),
        define("utils", ["constants", "underscore"], function (constants, _) {
            var utils = {};
            return utils.isVowel = function (character) {
                var vowels = "aeiouyAEIOUY".split("");
                if (1 !== character.length)
                    throw new Error('Function "isVowel" can test only single character.');
                return _.contains(vowels, character)
            }
                ,
                utils.isNot = function (comparator) {
                    return function (value) {
                        return !comparator(value)
                    }
                }
                ,
                utils.stringContainsString = function (str) {
                    return /^[a-zA-z\s_-]+$/g.test("" + str) && !/[\^\]\[\`\\]/g.test("" + str)
                }
                ,
                utils.stringContainsInteger = function (str) {
                    return /^[0-9]+$/g.test("" + str)
                }
                ,
                utils.stringContainsFloat = function (str) {
                    return /^[0-9\.]+$/g.test("" + str) && str.indexOf(".") !== str.length - 1 && str.indexOf(".") === str.lastIndexOf(".") && str.indexOf(".") > -1
                }
                ,
                utils.stringContainsBoolean = function (str) {
                    return _.contains(["true", "false"], str.toLowerCase())
                }
                ,
                utils.trim = function (str) {
                    if (!_.isString(str))
                        throw new Error("Only string can be trimmed.");
                ...
                utils.dashToCamel = function (str) {
                    var parts = _.filter(str.toLowerCase().split("-"), utils.isNot(_.isEmpty));
                    return _.map(parts, function (item, i) {
                        return i && item && (item = utils.capitalise(item)),
                            item
                    }).join("")
                }
                ,
                utils.createAttrName = function (name) {
                    return constants.ATTR_NAMESPACE + constants.DATA_DELIMITER + name.toLowerCase()
                }
                ,
                utils.createDataAttrName = function (name) {
                    return constants.DATA + constants.DATA_DELIMITER + utils.createAttrName(name)
                }
                ,
                utils.getAllDataAttrNames = function (name) {
                    var attrName;
                    if (_.isString(name))
                        attrName = name;
                    else {
                        if (!_.isArray(name))
                            throw new Error("Data attribute name can be only type of String or Array (of Strings).");
                        attrName = name.join(constants.DATA_DELIMITER)
                    }
                    return {
                        name: attrName,
                        dataValue: utils.createAttrName(attrName),
                        dataAttr: utils.createDataAttrName(attrName)
                    }
                }
                ,
                utils.createModuleNamespace = function (str) {
                    return _.reject(str.split(""), utils.isVowel).splice(0, 3).join("").toLowerCase()
                }
                ,
                utils.parseCommaValue = function (value) {
                    return _.filter(_.map(value.split(constants.ATTR_DELIMITER), utils.trim), utils.isNot(_.isEmpty))
                }
                ,
                utils.undefinedIfEmpty = function (val) {
                    return _.isElement(val) || !_.isEmpty(val) || _.isNumber(val) ? val : void 0
                }
                ,
                ...
                ,
                utils.getArgsNames = function (func) {
                    var args = func.toString().replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm, "").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(",");
                    return _.isEmpty(args) || _.isEmpty(args[0]) && 1 === args.length ? [] : args
                }
                ,
                utils.handleConfObjInArguments = function (argNames, argObj) {
                    var args = _.toArray(argObj)
                        , result = args;
                    return 1 === args.length && _.isPlainObject(args[0]) && (result = _.reduceRight(argNames, function (r, c) {
                        return (!_.isUndefined(args[0][c]) || r.length) && r.unshift(_.isUndefined(args[0][c]) ? void 0 : args[0][c]),
                            r
                    }, [])),
                        result
                }
                ,
                utils.acceptConfObj = function (func) {
                    var argNames = utils.getArgsNames(func);
                    return function () {
                        var args = utils.handleConfObjInArguments(argNames, arguments);
        ...
        define("channels", ["constants", "postal", "utils"], function (constants, Postal, Utils) {
            var channels = {};
            return channels.createTopicName = function (topics) {
                return _.isArray(topics) ? topics.join(constants.TOPIC_DELIMITER) : _.isEmpty(topics) ? "" : "" + topics
            }
                ,
                channels.appChannel = function () {
                    return Postal.channel(constants.APPLICATION_CHANNEL)
                }
                ,
                channels._appSubscribe = function (topic, callback) {
                    return Postal.subscribe({
                        channel: constants.APPLICATION_CHANNEL,
                        topic: channels.createTopicName(topic),
                        callback: callback
                    })
                }
                ,
                channels.appSubscribe = Utils.acceptConfObj(channels._appSubscribe),
                channels._appPublish = function (topic, data) {
                ...
                ,
                channels.appPublish = Utils.acceptConfObj(channels._appPublish),
                channels.limitToChannel = function (name) {
                    return function () {
                        return Postal.channel(name)
                    }
                }
                ,
                channels.limitSubscription = function (channel, mainTopic) {
                    return Utils.acceptConfObj(function (topic, callback) {
                        return Postal.subscribe({
                            channel: channel,
                            topic: mainTopic + constants.TOPIC_DELIMITER + channels.createTopicName(topic),
                            callback: callback
                        })
                    })
                }
                ,
                channels.limitPublish = function (channel, mainTopic) {
                    return Utils.acceptConfObj(function (topic, data) {
                        return Postal.publish({
                            channel: channel,
                            topic: mainTopic + constants.TOPIC_DELIMITER + channels.createTopicName(topic),
                            data: data
                ...
                ,
                channels.getChannelsForInstance = function (moduleName, instanceName) {
                    return {
                        channel: channels.limitToChannel(moduleName),
                        subscribe: channels.limitSubscription(moduleName, instanceName),
                        publish: channels.limitPublish(moduleName, instanceName),
                        topic: channels.createTopicName
                    }
                }
                ,
                channels
        }),
        define("modules/shop/view/BasketStatusView", ["underscore", "jquery", "backbone", "channels"], function (_, $, Backbone, Channels) {
            var BasketStatusView = Backbone.View.extend({
                initialize: function (options) {
                    this._channel = Channels.limitToChannel("Shop"),
                        this._channel().subscribe("basket.dataRecieved", _.bind(this.updateBasket, this)),
                        this._channel().subscribe("cart.update", _.bind(this.updateCart, this)),
                        this.templates = {
                            single: _.template($(this.el).data("single") + ""),
                            multi: _.template($(this.el).data("multi") + "")
                        },
                        $.ajax({
                            url: "/cgi-bin/shopform.cgi",
                            data: {
                                todo: "getBasket",
                                ajax: 1,
                                tok: Rothko.csrfToken
                            },
                            cache: !1,
                            type: "GET"
                        }).done($(this.el).show()).done(_.bind(this.updateBasket, this))
                },
                count: 0,
                ...
                updateCart: function (data) {
                    this.count = data.total_item_count,
                        this.render()
                },
                render: function () {
                    return this.$(".count").html(this._getTemplate(this.count)({
                        count: this.count
                    })),
                        this
                },
                _getTemplate: function (count) {
                    return 1 == count ? this.templates.single : this.templates.multi
                }
            });
            return BasketStatusView
        }),
        define("modules/shop/bundle/BasketElement", ["underscore", "jquery", "backbone", "modules/shop/view/BasketStatusView"], function (_, $, Backbone, BasketStatusView) {
            var BasketElement = Backbone.View.extend({
                el: $("body"),
                _basketStatus: [],
                _started: !1,
                go: function () {
                    ...
                    var _self = this;
                    this._started = !0,
                        $(".basket-status").each(function () {
                            _self._basketStatus.push(new BasketStatusView({
                                el: this
                            }))
                        })
                }
        ...
        define("modules/basket/basket", ["modules/shop/bundle/BasketElement"], function (BasketElement) {
            return function () {
                return {
                    init: function () {
                        (new BasketElement).go()
                    }
                }
            }
        }),
        define("modules/shop/view/CartLineView", ["underscore", "jquery", "backbone", "channels"], function (_, $, Backbone, Channels) {
            "use strict";
            var CartLineView = Backbone.View.extend({
                shopURL: "/cgi-bin/shopform.cgi",
                events: {
                    "click .remove": "removeCartLine"
                },
                initialize: function (options) {
                    this._error = options.error,
                        this.$(".quantity").on("change", _.bind(this.updateQuantity, this)),
                        this.currentQuantity = parseInt(this.$(".quantity").val(), 10),
                        this._channel = Channels.limitToChannel("Shop")
                },
                updateQuantity: function (event) {
                    event.preventDefault();
                    var quantity = parseInt($(event.target).val(), 10);
                    _.isNumber(quantity) && quantity > 0 ? $.post(this.shopURL, {
                        todo: "adjustCart",
                        ajax: "1",
                        tok: Rothko.csrfToken,
                        product_id: this.productId(),
                        quantity: quantity
                    }).then(_.bind(function (data, status, xhr) {
                        return "shop.lib.Cart" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Cart").promise() : (this.currentQuantity = quantity,
                            this.updateLinePrice(this.extractCartLine(data).line_price),
                            void this._channel().publish("cart.update", data))
                    }, this)).fail(_.bind(function (xhr, data, errorThrown) {
                        if (data["!"]) {
                            var cartLine = this.extractCartLine(data.cart);
                            this._error.processBackendError(data),
                                this.updateLinePrice(cartLine.line_price),
                                this.setQuantity(cartLine.item_count),
                                this._channel().publish("cart.update", data.cart)
                        } else
                            this.resetQuantity(),
                                this._error.processRequestError("recalculateCart")
                    }, this)) : $(event.target).val(this.currentQuantity)
                },
                removeCartLine: function (event) {
                    event.preventDefault(),
                        $.post(this.shopURL, {
                            todo: "removeFromCart",
                            ajax: "1",
                            ...
                            return "shop.lib.Cart" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Cart").promise() : (this.$(".quantity").off(),
                                this.remove(),
                                void this._channel().publish("cart.update", data))
                        }, this)).fail(_.bind(function (xhr, data, errorThrown) {
                            data["!"] ? this._error.processBackendError(data) : this._error.processRequestError("removeFromCartCart")
                        }, this))
                },
                productId: function () {
                    return this.$el.data("productid")
                },
                ...
                updateLinePrice: function (price) {
                    this.$(".linePrice p").text(price)
                },
                extractCartLine: function (data) {
                    return _.find(data.cartlines, _.bind(function (data) {
                        return data.product.product_id == this.productId()
                    }, this))
                }
            });
            return CartLineView
        }),
        define("modules/shop/view/ShippingOptionsView", ["underscore", "jquery", "backbone", "channels"], function (_, $, Backbone, Channels) {
            var ShippingOptions = Backbone.View.extend({
                shopURL: "/cgi-bin/shopform.cgi",
                selectedShipping: {
                    id: null
                },
                initialize: function (options) {
                    this._error = options.error,
                        this._channel = Channels.limitToChannel("Shop"),
                        this.selectedShipping.id = $(this.el).val(),
                        this._channel().subscribe("cart.update", _.bind(this.update, this)),
                        $(this.el).on("change", _.bind(this.setShipping, this))
                },
                setShipping: function (event) {
                    event.preventDefault();
                    var shippingId = $(event.target).val();
                    $.post(this.shopURL, {
                        todo: "setCartShippingOption",
                        ajax: "1",
                        tok: Rothko.csrfToken,
                        id: shippingId
                    }).then(_.bind(function (data, status, xhr) {
                        return "shop.lib.Cart" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Cart").promise() : void this._channel().publish("cart.update", data)
                    }, this)).fail(_.bind(function (xhr, data, errorThrown) {
                        data["!"] ? this._error.processBackendError(data) : this._error.processRequestError("setCartShippingOption")
                    }, this))
                },
                update: function (data) {
                    if (data.shipping_regions) {
                        $(this.el).find("optgroup").remove(),
                            _.each(data.shipping_regions, function (group, index, list) {
                                var optionGroupElement = this._buildOptionGroup(group);
                                optionGroupElement !== !1 && $(this.el).append(optionGroupElement)
                            }, this)
                    }
                },
                _buildOptionGroup: function (group) {
                    if ("shop.cart.ShippingRegion" !== group["!"])
                        return !1;
                    var optionGroup = document.createElement("optgroup")
                        , itemSelected = !1;
                    optionGroup.label = group.name;
                    return _.each(group.options, function (option, index, list) {
                        var optionElement = this._buildOption(option);
                        return optionElement === !1 ? !1 : (optionElement.selected === !0 && (this.selectedShipping.id = optionElement.dataset.id,
                            itemSelected = !0),
                            void optionGroup.appendChild(optionElement))
                    }, this),
                        optionGroup
                },
                _buildOption: function (option) {
                    if ("shop.cart.ShippingOption" !== option["!"])
                        return !1;
                    var optionElement = document.createElement("option");
                    return optionElement.value = option.id,
                        optionElement.dataset.id = option.id,
                        optionElement.selected = option.selected,
                        optionElement.text = option.name + " - " + option.price,
                        optionElement
                }
            });
            return ShippingOptions
        }),
        define("modules/shop/view/PayPalCheckoutView", ["underscore", "jquery", "backbone"], function (_, $, Backbone) {
            var PayPalCheckoutView = Backbone.View.extend({
                events: {
                    "click .paypal": "checkoutWithAccount",
                    "click .checkout": "checkoutWithoutAccount"
                },
                initialize: function (options) {
                    this.selectedShipping = options.selectedShipping,
                        this._error = options.error
                },
                checkoutWithAccount: function () {
                    this.checkout(!0)
                },
                checkoutWithoutAccount: function () {
                    this.checkout(!1)
                },
                checkout: function (withAccount) {
                    this.selectedShipping.id ? $.post("/cgi-bin/ppexpressfacade.cgi", {
                        todo: "setExpressCheckout",
                        ajax: "1",
                        tok: Rothko.csrfToken,
                        paypal_account: withAccount ? 1 : 0
                    }).then(function (data, status, xhr) {
                        return "shop.lib.ExpressCheckout" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Cart").promise() : void (window.location = data.url.url)
                    }).fail(_.bind(function (xhr, data, errorText) {
                        data["!"] ? this._error.processBackendError(data) : this._error.processRequestError("setExpressCheckout")
                    }, this)) : this._error.processRequestError("noShippingChosen")
                }
            });
            return PayPalCheckoutView
        }),
        define("modules/shop/view/PromoCodeView", ["underscore", "jquery", "backbone", "channels"], function (_, $, Backbone, Channels) {
            var PromoCode = Backbone.View.extend({
                shopURL: "/cgi-bin/shopform.cgi",
                initialize: function (options) {
                    return this._error = options.error,
                        this._channel = Channels.limitToChannel("Shop"),
                        this.$entry = $(".promo-entry"),
                        this.$entry ? (this.$error = $(".promo-error"),
                            this.$discountLabel = $(".discountLabel"),
                            this.$discountAmount = $(".discountAmount"),
                            this.validPromoCode = !1,
                            this.discountApplicable = !1,
                            "none" !== this.$discountAmount.css("display") && (this.validPromoCode = !0),
                            "line-through" !== this.$discountAmount.css("text-decoration") && (this.discountApplicable = !0),
                            $(".promo-apply").on("click", _.bind(this.applyPromoCode, this)),
                            void this._channel().subscribe("cart.update", _.bind(this._updateCartDiscount, this))) : !1
                },
                _updateCartDiscount: function (data) {
                    if (data.discount) {
                        if ("shop.cart.Discount" !== data.discount["!"])
                            return void this.$error.show();
                        this.$error.hide(),
                            this._setDiscountDisplay(data.discount),
                            this.$discountLabel.show(),
                            this.$discountAmount.show(),
                            this._checkForMinimumOrder(data.discount),
                            this.validPromoCode = !0,
                            this.discountApplicable = !data.discount.not_applicable
                    } else
                        this.$discountLabel.hide(),
                            this.$discountAmount.hide(),
                            this._setDiscountDisplay("", "N/A", "0"),
                            this.validPromoCode = !1,
                            this.discountApplicable = !1
                },
                _checkForMinimumOrder: function (discount) {
                    discount.not_applicable && (this.validPromoCode || this._error.processRequestError("mimumOrderNotMet"),
                        this.validPromoCode && this.discountApplicable && this._error.processRequestError("mimumOrderNotMet"))
                },
                _setDiscountDisplay: function (discount) {
                    discount.not_applicable ? (this.$discountLabel.css("text-decoration", "line-through"),
                        this.$discountAmount.css("text-decoration", "line-through")) : (this.$discountLabel.css("text-decoration", "none"),
                            this.$discountAmount.css("text-decoration", "none")),
                        this.$entry.val(discount.promo_code),
                        $(this.$discountLabel).find("p").text(discount.description),
                        $(this.$discountAmount).find("p").text(discount.price)
                },
                applyPromoCode: function (event) {
                    event.preventDefault(),
                        $.post(this.shopURL, {
                            ...
                            ajax: "1",
                            tok: Rothko.csrfToken,
                            promo_code: this.$entry.val()
                        }).then(_.bind(function (data, status, xhr) {
                            return "shop.lib.Cart" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Cart").promise() : void this._channel().publish("cart.update", data)
                        }, this)).fail(_.bind(function (xhr, data, errorThrown) {
                            data["!"] ? this._error.processBackendError(data) : this.$error.show()
                        }, this))
                }
            });
            return PromoCode
        }),
        define("modules/shop/view/CartView", ["underscore", "jquery", "backbone", "modules/shop/view/CartLineView", "modules/shop/view/ShippingOptionsView", "modules/shop/view/PayPalCheckoutView", "modules/shop/view/PromoCodeView", "channels"], function (_, $, Backbone, CartLineView, ShippingOptionsView, PayPalCheckoutView, PromoCodeView, Channels) {
            var CartView = Backbone.View.extend({
                ...
                initialize: function (options) {
                    ...
                    this._channel = Channels.limitToChannel("Shop"),
                        this._channel().subscribe("cart.update", _.bind(this.update, this)),
                        this.$(".cartline").each(function (element) {
                            _self.cartlines.push(new CartLineView({
                                el: this,
                                error: _self._error
                            }))
                        }),
                        this.shipping = new ShippingOptionsView({
                            el: this.$(".shipping").first(),
                            error: this._error
                        }),
                        this.promoCode = new PromoCodeView({
                            el: this.$(".promoCode").first(),
                            error: _self._error
                        }),
                        this.checkout = new PayPalCheckoutView({
                            el: this.$(".summary").first(),
                            selectedShipping: this.shipping.selectedShipping,
                            error: this._error
                        }),
                ...
                update: function (data) {
                    this.$total.text(data.total_price || ""),
                        this.$subtotal && this.$subtotal.text(data.cart_subtotal_price)
                }
            });
            return CartView
        }),
        !function () {
            ...
            this.Class = function () { }
                ...
                Class.extend = function (prop) {
                    ...
                    return Class.prototype = prototype,
        ...
        define("structure", ["constants", "utils", "underscore", "jquery"], function (constants, utils, _, $) {
            var structure = {};
            return structure.wrapEl = function (el) {
                return el instanceof $ ? el : $(el)
            }
                ,
                structure.unwrapEl = function (el) {
                    return el instanceof $ ? el[0] : el
                }
                ,
                structure.tagElWithId = function (el, id) {
                    return structure.wrapEl(el).data(utils.createAttrName(constants.STRUCTURE_ID), id),
                        el
                }
                ,
                structure.getIdTag = function (el) {
                    return structure.wrapEl(el).data(utils.createAttrName(constants.STRUCTURE_ID));
                }
                ,
                structure.parseValue = function (str) {
                    var result;
                    return result = utils.stringContainsString(str) && !utils.stringContainsBoolean(str) ? utils.trim(str) : utils.parseJSON(str),
                        result instanceof Error ? {} : result
                }
                ,
                structure.findParentName = function (el, namespace) {
                    var $el = structure.wrapEl(el)
                        , marker = utils.getAllDataAttrNames([namespace, constants.DATA_ELEMENT])
                        , $parent = $el.parents("[" + marker.dataAttr + "]").first()
                        , name = structure.getIdTag($parent);
                    return _.isEmpty(name) ? constants.STRUCTURE_ROOT : name
                }
                ,
                structure.extractAttributes = function (el, namespace) {
                    var domEl = structure.unwrapEl(el)
                        , dataNamespace = utils.createDataAttrName(namespace) + constants.DATA_DELIMITER
                        , namespaceMatch = new RegExp("^" + dataNamespace + ".+")
                        , namespaceReplace = new RegExp("^" + dataNamespace)
                        , isElAttr = new RegExp("^" + dataNamespace + constants.DATA_ELEMENT)
                        , attributes = {};
                    return _.each(domEl.attributes, function (item) {
                        var optionName;
                        namespaceMatch.test(item.nodeName) && !isElAttr.test(item.nodeName) && (optionName = utils.dashToCamel(item.nodeName.replace(namespaceReplace, "")),
                            attributes[optionName] = structure.parseValue(item.nodeValue))
                    }),
                        attributes
                }
                ,
                structure.getChildrenElements = function (el, namespace) {
                    var $parent = structure.wrapEl(el)
                        , target = utils.getAllDataAttrNames([namespace, constants.DATA_ELEMENT])
                        , elements = {};
                    return $parent.find("[" + target.dataAttr + "]").each(function () {
                        var $this = $(this)
                            , name = $this.data(target.dataValue)
                            , id = _.uniqueId(name);
                        structure.tagElWithId($this, id),
                            _.isUndefined(elements[name]) && (elements[name] = []),
                            elements[name].push({
                                id: id,
                                el: $this[0],
                                parent: structure.findParentName($this, namespace),
                                attr: structure.extractAttributes($this, namespace)
                            })
                    }),
                        elements
                }
                ,
                structure.createMetaStructure = function (obj, namespace) {
                    var meta = {};
                    return meta[constants.STRUCTURE_ROOT] = [{
                        id: constants.STRUCTURE_ROOT,
                        el: structure.unwrapEl(obj),
                        parent: !1,
                        attr: structure.extractAttributes(obj, namespace)
                    }],
                        structure.tagElWithId(obj, constants.STRUCTURE_ROOT),
                        _.extend(meta, structure.getChildrenElements(obj, namespace))
                }
                ,
                structure.fn = {},
                structure.fn.getItemStack = function (name) {
                    return utils.undefinedIfEmpty(this.elements[name])
                }
                ,
                structure.fn.getAllEl = function (name) {
                    return utils.undefinedIfEmpty(_.pluck(this.getItemStack(name), "el"))
                }
                ,
                structure.fn.getAll$El = function (name) {
                    return utils.undefinedIfEmpty(_.map(this.getAllEl(name), structure.wrapEl))
                }
                ,
                structure.fn.getEl = function (name) {
                    return utils.undefinedIfEmpty(_.first(this.getAllEl(name)))
                }
                ,
                structure.fn.get$El = function (name) {
                    var el = this.getEl(name);
                    return _.isUndefined(el) ? void 0 : structure.wrapEl(el)
                }
                ,
                structure.fn.getAllAttributes = function (name) {
                    var item = this.getItemStack(name);
                    return _.isUndefined(item) ? void 0 : _.pluck(item, "attr")
                }
                ,
                structure.fn.getAttributes = function (name) {
                    return _.first(this.getAllAttributes(name))
                }
                ,
                structure.fn.getMainEl = function () {
                    return this.getEl(constants.STRUCTURE_ROOT)
                }
                ,
                structure.fn.getMain$El = function () {
                    return this.get$El(constants.STRUCTURE_ROOT)
                }
                ,
                structure.fn.getMainAttributes = function () {
                    return this.getAttributes(constants.STRUCTURE_ROOT)
                }
                ,
                structure.fn.getConfig = function () {
                    var mainElConf = this.getMainAttributes()[constants.STRUCTURE_CONFIG];
                    return _.isUndefined(mainElConf) ? {} : mainElConf
                }
                ,
                structure.fn.findItemById = function (tagId) {
                    return _.first(_.reduce(this.elements, function (result, item) {
                        var search;
                        return result.length || (search = _.find(item, {
                            id: tagId
                        }),
                            _.isEmpty(search) || result.push({
                                stack: item,
                                self: search
                            })),
                            result
                ...
                ,
                structure.fn.findItem = function (el) {
                    return this.findItemById(structure.getIdTag(el))
                }
                ,
                structure.fn.findParentItem = function (el) {
                    var thisEl = this.findItem(el)
                        , parent = void 0;
                    return _.isEmpty(thisEl) || _.isUndefined(thisEl.self) || (parent = this.findItemById(thisEl.self.parent),
                        parent = _.isEmpty(parent) ? void 0 : parent.self),
                        parent
                }
                ,
                structure.fn.findParentEl = function (el) {
                    return _.isEmpty(this.findParentItem(el)) ? void 0 : this.findParentItem(el).el
                }
                ,
                structure.fn.findParent$El = function (el) {
                    var parent = this.findParentEl(el);
                    return _.isUndefined(parent) ? void 0 : structure.wrapEl(parent)
                }
                ,
                structure.fn.findSiblingItems = function (el) {
                    var siblings = this.findItem(el);
                    return _.without(siblings.stack, siblings.self)
                }
                ,
                structure.fn.findSiblingEl = function (el) {
                    return utils.undefinedIfEmpty(_.pluck(this.findSiblingItems(el), "el"))
                }
                ,
                structure.fn.findSibling$El = function (el) {
                    return utils.undefinedIfEmpty(_.map(this.findSiblingEl(el), structure.wrapEl))
                }
                ,
                structure.fn.findAllSiblingItems = function (el) {
                    var items = this.findItem(el);
                    return _.isUndefined(items) ? void 0 : items.stack
                }
                ,
                structure.fn.findAllSiblingEl = function (el) {
                    return utils.undefinedIfEmpty(_.pluck(this.findAllSiblingItems(el), "el"))
                }
                ,
                structure.fn.findAllSibling$El = function (el) {
                    return utils.undefinedIfEmpty(_.map(this.findAllSiblingEl(el), structure.wrapEl))
                }
                ,
                structure.getStructureForInstance = function (obj, namespace) {
                    var els = structure.createMetaStructure(obj, namespace)
                        , api = {
                            elements: els
                        };
                    return _.extend(api, structure.fn),
                        _.bindAll(api),
                        api
                }
                ,
        ...
        define("app", ["jquery", "constants", "utils", "channels", "structure", "i18n"], function ($, constants, utils, channels, structure, i18n) {
            var App = {};
            return App.constants = constants,
                App.utils = utils,
                App.i18n = i18n,
                App.instances = {},
                App.core = {},
                App.debug = !1,
                App.core.generateInstanceName = function (str) {
                    var parts = _.map(str.split(App.constants.INSTANCE_AS), utils.trim)
                        , result = {
                            module: parts[0],
                            name: _.uniqueId(utils.capitalise(parts[0])),
                            namespace: parts[0]
                        };
                    return parts.length > 1 && (result.name = utils.capitalise(parts[1]),
                        result.namespace = result.name),
                        result
                }
                ,
                App.core.getModuleStructure = function ($module) {
                    var moduleRawStr = $module.data(App.utils.createAttrName(App.constants.MODULE))
                        , allModules = App.utils.parseCommaValue(moduleRawStr)
                        , modules = [];
                    return allModules.length > 1 && App.core.checkIfLoaded(allModules.length - 1),
                        _.each(allModules, function (item) {
                            var instanceInfo = App.core.generateInstanceName(item)
                                , data = {};
                            data.el = $module[0],
                                data.name = instanceInfo.name,
                                data.module = instanceInfo.module,
                                data.namespace = App.utils.createModuleNamespace(instanceInfo.namespace),
                                $module.attr(App.utils.createDataAttrName(App.constants.INSTANCE), data.name),
                                data.installChannels = function () {
                                    return channels.getChannelsForInstance(data.module, data.name)
                                }
                                ,
                                data.installStructure = function () {
                                    return structure.getStructureForInstance(data.el, data.namespace)
                                }
                                ,
                                modules.push(data)
                        }),
                ...
                ,
                App.core.setLoadCheck = function (num) {
                    var remaining = num;
                    return function (op) {
                        remaining += _.isUndefined(op) ? -1 : op,
                            0 >= remaining && channels.appPublish(App.constants.INIT_METHOD, {})
                    }
                }
                ,
                App.core.createInstance = function (data) {
                    var modulePath = App.constants.MODULE_PATH + App.constants.PATH_DELIMITER + data.module + App.constants.PATH_DELIMITER + data.module;
                    require([modulePath], function (module) {
                        var newInstance = module(data);
                        App.instances[data.name] = _.extend({
                            instance: newInstance
                        }, _.reduce(data, function (result, item, key) {
                            return _.isFunction(item) || (result[key] = item),
                                result
                        }, {})),
                            $(data.el).removeAttr(App.utils.createDataAttrName(App.constants.MODULE)),
                            _.isFunction(newInstance[App.constants.INIT_METHOD]) && (channels.appSubscribe(App.constants.INIT_METHOD, _.bind(newInstance[App.constants.INIT_METHOD], newInstance)).disposeAfter(1),
                                App.core.checkIfLoaded())
                    })
                }
                ,
                App.core.initModule = function ($module) {
                    _.each(App.core.getModuleStructure($module), function (data) {
                        App.core.createInstance(data)
                    })
                }
                ,
                App.core.findModules = function ($target) {
                    var $context = $target instanceof $ ? $target : $("body");
                    return $context.find("[" + App.utils.createDataAttrName(App.constants.MODULE) + "]")
                }
                ,
                App.getInstance = function (name) {
                    if (_.isUndefined(App.instances[name]))
                        throw new Error('Instance "' + name + "\" doesn't exist.");
                    return App.instances[name]
                }
                ,
                App.destroyInstance = function (instanceName) {
                    var name = _.isPlainObject(instanceName) ? _.isUndefined(instanceName.name) ? "" : instanceName.name : "" + instanceName;
                    return _.isUndefined(App.instances[name]) || _.isNull(App.instances[name]) ? !1 : (_.isFunction(App.instances[name].instance.destroy) && (App.instances[name].destroy = !0,
                        App.instances[name].instance.destroy()),
                        App.instances[name] = null,
                        !0)
                }
                ,
                App.getAllInstanceForModule = function (name) {
                    return _.reduce(App.instances, function (result, instance) {
                        return instance.module === name && result.push(instance),
                            result
                    }, [])
                }
                ,
                App.getConfigFromInstance = function (instance) {
                    var confStr, confData = utils.createAttrName(instance.namespace + constants.DATA_DELIMITER + constants.STRUCTURE_CONFIG);
                    return _.isFunction(instance.el.getAttribute) ? (confStr = instance.el.getAttribute(constants.DATA + constants.DATA_DELIMITER + confData),
                        confStr = _.isEmpty(confStr) ? "{}" : confStr) : confStr = _.isUndefined(instance.el.dataset) ? "{}" : instance.el.dataset[utils.dashToCamel(confData)] || "{}",
                        structure.parseValue(confStr)
                }
                ,
                App.init = function () {
                    var $allModules = App.core.findModules();
                    $allModules.length && (App.core.checkIfLoaded = App.core.setLoadCheck($allModules.length),
                        channels.appSubscribe("destroy", App.destroyInstance).withConstraint(function (data) {
                            return _.isUndefined(App.instances[data.name].destroy)
                        }),
                        $allModules.each(function () {
                            App.core.initModule($(this))
                        }))
                }
                ,
                App
        }),
        define("customerror", ["app"], function () {
            var _errors = {}
                , CustomError = {};
            return CustomError.factory = function (name) {
                if (_.has(_errors, name) && _.isFunction(_errors[name]))
                    return _errors[name];
                if (_.isEmpty(name))
                    throw new Error("Can't create or get custom Error - no name supplied.");
                return _errors[name] = function (message) {
                    this.message = name + ": " + message
                }
                    ,
                    _errors[name].prototype = new Error,
                    _errors[name]
            }
                ,
                CustomError.factory
        }),
        define("i18n", ["jquery", "underscore", "customerror", "utils"], function ($, _, customError, utils) {
            var DEFAULT_LANG = "en"
                , LANG_ISO_CODES = "".match(/.{2}/g)
                , SCRIPT_TEMPLATE_TYPE = "text/i18n"
                , SCRIPT_TEMPLATE_DATA_LANG = "lang"
                , dictionary = {};
            dictionary[DEFAULT_LANG] = {};
            var activeLang = DEFAULT_LANG
                , I18nError = customError("i18n")
                , i18n = {};
            return i18n.pluralize = function (num, other, options) {
                return _.has(options, num) ? options[num] : other
            }
                ,
                i18n.normalizeLangString = function (lang) {
                    var normalized;
                    if (!_.isUndefined(lang) && (normalized = ("" + lang).toLocaleLowerCase().replace(/[\s\W\d]/g, ""),
                        !_.isEmpty(normalized))) {
                        if (!_.contains(LANG_ISO_CODES, normalized))
                            throw new I18nError("Not valid language ISO 639-1 code.");
                        return normalized
                    }
                }
                ,
                i18n.getLangKey = function (lang) {
                    var langStr = i18n.normalizeLangString(lang)
                        , langKey = _.isEmpty(langStr) ? DEFAULT_LANG : langStr;
                    return _.isUndefined(dictionary[langKey]) && (dictionary[langKey] = {}),
                        langKey
                }
                ,
                i18n.tagExists = function (tag, lang) {
                    var langKey = i18n.getLangKey(lang)
                        , langDictionary = dictionary[langKey];
                    return !_.isUndefined(langDictionary[tag]) && !_.isNull(langDictionary[tag])
                }
                ,
                i18n.detectTemplate = function (str) {
                    return !_.isEmpty(str.match(_.templateSettings.escape)) || !_.isEmpty(str.match(_.templateSettings.evaluate)) || !_.isEmpty(str.match(_.templateSettings.interpolate))
                }
                ,
                i18n.processDictionary = function (list) {
                    if (!_.isPlainObject(list))
                        throw new I18nError("Dictionary has to be a plain object.");
                    return _.reduce(list, function (result, value, key) {
                        return _.isString(value) && (result[key] = i18n.detectTemplate(value) ? _.template(value) : value),
                            result
                    }, {})
                }
                ,
                i18n.addDictionary = function (list, lang) {
                    var appendix = i18n.processDictionary(list)
                        , langKey = i18n.getLangKey(lang);
                    return _.isEmpty(appendix) || _.extend(dictionary[langKey], appendix),
                        _.keys(appendix)
                }
                ,
                i18n.translate = function (tag, values) {
                    var translation, langKey = i18n.getLangKey(activeLang);
                    return i18n.tagExists(tag, langKey) ? (translation = dictionary[langKey][tag],
                        _.isFunction(translation) && (translation = translation(_.extend({}, values, {
                            pluralize: i18n.pluralize
                        }))),
                        "" + translation) : void 0
                }
                ,
                i18n.safeTranslate = function (tag, fallback, values) {
                    var translated = i18n.translate(tag, values);
                    return _.isEmpty(translated) ? _.isFunction(fallback) ? fallback(values) : "" + fallback : translated
                }
                ,
                i18n.loadFromObject = function ($obj) {
                    var langTarget, list;
                    if (!($obj instanceof $))
                        throw new I18nError("Object must be jQuery instance.");
                    if (list = utils.parseJSON($obj.html()),
                        langTarget = $obj.data(SCRIPT_TEMPLATE_DATA_LANG),
                        list instanceof Error)
                        throw new I18nError("Can't load dictionary from HTML. Corrupted JSON structure.");
                    return $obj.remove(),
                        i18n.addDictionary(list, langTarget)
                }
                ,
                i18n.loadFromContainer = function ($container) {
                    var result = [];
                    if (!($container instanceof $))
                        throw new I18nError("Container must be jQuery instance.");
                    return $container.find('script[type="' + SCRIPT_TEMPLATE_TYPE + '"]').each(function () {
                        var $this = $(this)
                            , keys = i18n.loadFromObject($this);
                        _.isEmpty(keys) || (result = _.union(result, keys))
                    }),
                        result
                }
                ,
                i18n.loadFromPage = function () {
                    return i18n.loadFromContainer($(document))
                }
                ,
                i18n.getAllTags = function () {
                    var all = [];
                    return _.each(dictionary, function (section, lang) {
                        all = _.union(all, _.reduce(section, function (result, value, tag) {
                            return i18n.tagExists(tag, lang) && result.push(tag),
                                result
                        }, []))
                    }),
                        all
                ...
                ,
                i18n.getActiveLang = function () {
                    return activeLang
                }
                ,
                i18n.getLangISOCodes = function () {
                    return LANG_ISO_CODES.concat([])
                }
                ,
                i18n.switchLang = function (lang) {
                    var langKey = i18n.normalizeLangString(lang);
                    return _.has(dictionary, langKey) ? (activeLang = langKey,
                        !0) : !1
                }
                ,
                i18n.removeTag = function (tag, lang) {
                    var langKey = i18n.getLangKey(lang);
                    return i18n.tagExists(tag, lang) ? (dictionary[langKey][tag] = null,
                        !0) : !1
                }
                ,
                i18n.purgeDictionary = function (confirmation) {
                    if ("Yes" === confirmation)
                        return dictionary = {},
                            dictionary[DEFAULT_LANG] = {},
                            !0;
                    throw new I18nError("In order to purge the dictionary you have to confirm it!")
                }
                ,
                i18n
        }),
        define("modules/shop/service/ErrorService", ["class", "i18n"], function (Class, i18n) {
            var sSpace = " "
                , _errorMessagesAsText = !0
                , sBullet = "• "
                , sBoldTag = "<b>";
            sBoldTag = _errorMessagesAsText ? "" : "<b>";
            var sEndBoldTag = "</b>";
            sEndBoldTag = _errorMessagesAsText ? "" : sEndBoldTag;
            var sBreakTag = "<br />";
            sBreakTag = _errorMessagesAsText ? "\n" : sBreakTag;
            var sReviewCart = (i18n.safeTranslate("Shop_Sorry_Text", "Sorry, the item") + sSpace,
                i18n.safeTranslate("Shop_Review_Cart", "Please review your cart."))
                , sTryAgain = i18n.safeTranslate("Shop_Try_Again", " Please try again.")
                , unknownErrorMessage = i18n.safeTranslate("Shop_Action_Failed", "Sorry, the action failed.") + sSpace + sTryAgain
                , sSorryOrderText = i18n.safeTranslate("Shop_Sorry_Order_Text", "Sorry, we could not display your order.") + sSpace + sTryAgain
                , sSorryItemsUnavailable = i18n.safeTranslate("Shop_Items_Unavailable", "Sorry, some of the items in your basket are no longer available.")
                , sSorryItemUnavailable = i18n.safeTranslate("Shop_Item_Unavailable", "Sorry, the item") + sSpace
                , sSorrySoldOut = i18n.safeTranslate("Shop_Sorry_Sold_Out", " has sold out.")
                , sSorryLimitedQuantity = i18n.safeTranslate("Shop_Sorry_Limited_Quantity", " has limited quantity.")
                , sSorryNotAvailable = i18n.safeTranslate("Shop_Not_Available", " is not available.")
                , ErrorService = Class.extend({
                    showErrorMsg: function (msg) {
                        alert(msg)
                    },
                    processRequestError: function (requestType, redirectUrl) {
                        var messages = {
                            addToBasket: i18n.safeTranslate("Shop_Add_To_Basket", "Sorry, we could not add to cart.") + sSpace + sTryAgain,
                            completeOrder: sSorryOrderText + sSpace,
                            setCartShippingOption: i18n.safeTranslate("Shop_Set_Cart_Shipping_Option", "Sorry, we could not update shipping.") + sSpace + sTryAgain,
                            setExpressCheckout: i18n.safeTranslate("Shop_Set_Express_Checkout", "Sorry could not proceed to PayPal.") + sSpace + sTryAgain,
                            recalculateCart: i18n.safeTranslate("Shop_Recalculate_Cart", "Sorry, we could not update cart.") + sSpace + sTryAgain,
                            removeFromCart: i18n.safeTranslate("Shop_Remove_From_Cart", "Sorry, we could not delete item from cart.") + sSpace + sTryAgain,
                            noShippingChosen: i18n.safeTranslate("Shop_No_Shipping_Chosen", "Please choose a shipping option") + sSpace,
                            mimumOrderNotMet: i18n.safeTranslate("Shop_Promocode_Minimum_not_Met", "Sorry, you have not met the minimum order amount to qualify for this promo code.")
                        };
                        messages[requestType] ? this.showErrorMsg(messages[requestType]) : this.showErrorMsg(unknownErrorMessage),
                            void 0 !== redirectUrl && (window.location = redirectUrl)
                    },
                    processBackendError: function (result, redirectUrl) {
                        var errorService = this
                            , messages = {
                                "shop.lib.PaymentError": function (errorType) {
                                    var message = sSorryOrderText + sSpace;
                                    switch (errorType) {
                                        case "INVALID_ORDER":
                                            message = i18n.safeTranslate("Shop_Invalid_Order", "Invalid order. Probably another order is in process.") + sSpace + sBreakTag + sBreakTag + sReviewCart;
                                            break;
                                        case "COMPLETED_CART":
                                            message = i18n.safeTranslate("Shop_Completed_Cart", "Invalid order. Probably another order was completed already.") + sSpace + sBreakTag + sBreakTag + sReviewCart;
                                            break;
                                        case "ERR_PAYMENT":
                                            message = i18n.safeTranslate("Shop_Error_Payment", "Payment failed.") + sSpace + sTryAgain;
                                            break;
                                        case "ERR_PAYPAL":
                                            message = i18n.safeTranslate("Shop_Error_PayPal", "Payment via PayPal failed.") + sSpace + sTryAgain
                                    }
                                    errorService.showErrorMsg(message)
                                },
                                "shop.lib.ExpressCheckoutError": function () {
                                    errorService.showErrorMsg(sSorryItemsUnavailable + sSpace + sBreakTag + sBreakTag + sReviewCart),
                                        window.location.refresh()
                                },
                                "shop.lib.StockLimitedBasket": function (result) {
                                    var variant_title;
                                    variant_title = void 0 === result.variant_title ? "" : " (" + result.variant_title + ")";
                                    var message = sSorryItemUnavailable + sBoldTag + result.title + variant_title + sEndBoldTag + sSpace;
                                    switch (result.limit_reason) {
                                        case "SOLD_OUT":
                                            message += sSorrySoldOut;
                                            break;
                                        case "QUANTITY":
                                            message += sSorryLimitedQuantity;
                                            break;
                                        default:
                                        case "UNAVAILABLE":
                                            message += sSorryNotAvailable
                                    }
                                    errorService.showErrorMsg(message),
                                        window.location.refresh()
                                },
                                "shop.lib.StockLimitedCart": function (result) {
                                    for (var product, product_id = result.limits[0][0], i = (result.limits[0][1],
                                        0); i < result.cart.cartlines.length; i++)
                                        if (result.cart.cartlines[i].product.product_id == product_id) {
                                            product = result.cart.cartlines[i].product;
                                            break
                                        }
                                    var variant_title;
                                    variant_title = void 0 === product.variant_description ? "" : " (" + product.variant_description + ")";
                                    var title = product.title + variant_title
                                        , message = sSorryItemsUnavailable + sBreakTag + sBreakTag + sBoldTag + sBullet + title + sEndBoldTag + sSpace;
        ...
        define("modules/shop/bundle/CartPage", ["underscore", "jquery", "backbone", "modules/shop/view/CartView", "modules/shop/service/ErrorService"], function (_, $, Backbone, CartView, ErrorService) {
            "use strict";
            var CartPage = Backbone.View.extend({
                el: $("body"),
                _basketStatus: [],
                _cart: [],
                _started: !1,
                go: function () {
                    ...
                    this._started = !0,
                        ...
                        $(".cart").each(function () {
                            _self._cart.push(new CartView({
                                el: this,
                                error: _self.errorService
                            }))
                        }),
        ...
        define("modules/cart/cart", ["modules/shop/bundle/CartPage"], function (CartPage) {
            return function () {
                return {
                    init: function () {
                        (new CartPage).go()
        ...
        define("modules/shop/view/ProductView", ["underscore", "jquery", "backbone", "channels"], function (_, $, Backbone, Channels) {
            "use strict";
            var ProductView = Backbone.View.extend({
                ...
                otherEvents: {
                    "click .addToCart": "goToCart"
                },
                initialize: function (options) {
                    _.bindAll(this, "addToCart", "goToCart", "reset"),
                        this._error = options.error,
                        this._channel = Channels.limitToChannel("Shop"),
                        this._addToCartText = this.$(".addToCart").text(),
                        this._cartPage = this.$el.data("cartpage"),
                        this.$('[name="product_id"]').on("change", _.bind(this.reset, this)),
                        this.$('[name="product_id"]').on("change", _.bind(this.updatePrice, this))
                },
                addToCart: function (event) {
                    event.preventDefault(),
                        $.post(this._form().attr("action"), this._form().serialize() + "&ajax=1").then(_.bind(function (data, textStatus, xhr) {
                            return "shop.lib.Basket" !== data["!"] ? $.Deferred().reject(xhr, data, "not a shop.lib.Basket").promise() : (this._channel().publish("basket.dataRecieved", data),
                                void this.setGoToCheckout())
                        }, this)).fail(_.bind(function (xhr, data, errorThrown) {
                            data["!"] ? this._error.processBackendError(data) : this._error.processRequestError("addToBasket")
                        }, this))
                },
                updatePrice: function (event) {
                    var price = $(event.target).find(":selected").data("price");
                    this.$(".price p").html(price)
                },
                reset: function () {
                    this.undelegateEvents(),
                        this.delegateEvents(),
                        this.$(".addToCart").text(this._addToCartText)
                },
                goToCart: function (event) {
                    event.preventDefault(),
                        window.location.href = this._cartPage
                },
                setGoToCheckout: function () {
                    this.undelegateEvents(),
                        this.delegateEvents(this.otherEvents),
                        this.$(".addToCart").text("Go to cart")
                },
                _form: function () {
                    return this.$("form")
                }
        ...
        define("modules/shop/bundle/ProductPage", ["underscore", "jquery", "backbone", "modules/shop/view/ProductView", "modules/shop/service/ErrorService"], function (_, $, Backbone, ProductView, ErrorService) {
            "use strict";
            var ProductPage = Backbone.View.extend({
                ...
                go: function () {
                    ...
                    $(".product-detail").each(function () {
                        _self._products.push(new ProductView({
                            el: this,
                            error: errorService
                        }))
                    })
        ...
        define("modules/productpage/productpage", ["backbone", "modules/shop/bundle/ProductPage"], function (Backbone, ProductPage) {
            return function () {
                return {
                    init: function () {
                        (new ProductPage).go()
        ...
        define("modules/form/events/form", {
            checkUploadFields: "checkUploadFields",
        ...
        define("modules/form/errors/form", {
            fieldMessage: function (config) {
                var fieldMsg = "string" == typeof config.fieldMsg && config.fieldMsg.length ? config.fieldMsg : "field";
                return {
                    invalid: "Invalid " + fieldMsg,
                    required: "Required field"
                }
            }
        }),
        define("modules/form/regex/form", {
            alpha: /^[A-Za-z]+$/,
        ...
        define("modules/form/ui", ["app", "jquery", "i18n", "modules/form/events/form", "jquery-iframe-transport"], function (App, $, i18n, FormEvents) {
            var UI = {
                errors: {
                    required: i18n.safeTranslate("Form_Required_Message", "Required field"),
                    invalid: i18n.safeTranslate("Form_Invalid_Message", "Invalid entry")
                },
                getFormNode: function () {
                    var form = this;
                    return _.isUndefined(form.html) || _.isUndefined(form.html.node) ? void 0 : form.html.node instanceof $ ? form.html.node : _.isElement(form.html.node) ? $(form.html.node) : void 0
                },
                removeErrorMsg: function () {
                    var form = this
                        , node = form.getFormNode();
                    return node ? (form.html.node.find(".smf-group").removeClass("has-error").find(".error-tt").text(""),
                        form) : form
                },
                addErrorMsg: function (node, msg) {
                    var form = this
                        , $parent = $(node).closest(".smf-group");
                    return $parent.addClass("has-error"),
                        $parent.find(".error-tt").text(msg),
                        form
                },
                showErrors: function (data) {
                    var form = this;
                    return form.removeErrorMsg(),
                        _.each(data.invalid && data.invalid.length ? data.invalid : [], function (field) {
                            var nodeType = ($(field[0]).attr("type") + "").toLowerCase();
                            field.length > 1 && ("checkbox" === nodeType || "radio" === nodeType) ? form.addErrorMsg($(field), form.errors.required) : form.addErrorMsg($(field), form.errors.invalid)
                        }),
                        _.each(data.required && data.required.length ? data.required : [], function (field) {
                            form.addErrorMsg($(field), form.errors.required)
                        }),
                        form.channel.publish(FormEvents.checkUploadFields),
                        form
                },
                displayMessage: function (tmplObj) {
                    var form = this
                        , rawTmpl = $(tmplObj).html()
                        , tmpl = _.template(rawTmpl)
                        , node = form.getFormNode();
                    return node ? (node.find("fieldset").hide(),
                        void node.append($(tmpl()))) : form
                },
                createSeed: function (timestamp, base) {
                    return parseInt(_.shuffle(Math.round(1e7 * Math.random()) + "" + timestamp.substr(timestamp.length - 4, timestamp.length)).join(""), 10).toString(base)
                },
                createRandomId: function (base, length) {
                    for (var form = this, uid = ""; uid.length < length;)
                        uid += form.createSeed(+new Date + "", base);
                    return uid.substr(0, length)
                },
                lockForm: function () {
                    var submitBtn, actionText, originalText, form = this, node = form.getFormNode();
                    return node ? (submitBtn = node.find("input[type=submit]"),
                        actionText = submitBtn.data("text-action"),
                        originalText = submitBtn.data("text-original"),
                        _.isUndefined(originalText) && submitBtn.data("text-original", submitBtn.val()),
                        node.find("fieldset").addClass("processing"),
                        void submitBtn.val(actionText)) : form
                },
                unlockForm: function () {
                    var submitBtn, form = this, node = form.getFormNode();
                    return node ? (submitBtn = node.find("input[type=submit]"),
                        node.find("fieldset").removeClass("processing"),
                        void submitBtn.val(submitBtn.data("text-original"))) : form
                },
                responseSuccess: function () {
                    var form = this
                        , node = form.getFormNode();
                    return node ? (node.find("fieldset").removeClass("processing").hide(),
                        form.displayMessage(node.find("script")[0]),
                        node.find(".resp").show(),
                        void (form.processing && (form.processing = !1))) : form
                },
                responseErrorValidation: function (data) {
                    var rejected, form = this, node = form.getFormNode();
                    return node ? (rejected = _.isArray(data.fields) ? data.fields : [],
                        void form.showErrors({
                            invalid: _.map(rejected, function (field) {
                                return node ? node.find('[name="' + field + '"]') : void 0
                            })
                        })) : form
                },
                responseErrorDefault: function () {
                    var form = this
                        , node = form.getFormNode();
                    return node ? void form.displayMessage(node.find("script")[1]) : form
                },
                createRequest: function () {
                    var form = this;
                    return form.removeErrorMsg(),
                        $(form.html.node).find("fieldset").addClass("processing"),
                        $.ajax(form.createRequestObject()).done(function (resp) {
                            form.requestComplete(resp)
                        }).fail(function () {
                            form.responseErrorDefault()
                        }).always(function () {
                            form.unlockForm()
                        }),
                        form
                ...
                createRequestObject: function () {
                    ...
                    return {
                        iframe: form.iframe,
                        files: form.iframe ? $(form.html.node).find(":file") : "",
                        url: form.endpoint,
                        type: "POST",
                        contentType: form.iframe ? "" : "application/json; charset=utf-8",
                        beforeSend: function (xhr) {
                            if (form.lockForm(),
                                !form.iframe) {
                                var csrf = "";
                                _.has(window, "tref") && !_.isEmpty(window.tref.tok) && (csrf = window.tref.tok),
                                    xhr.setRequestHeader("X-SM-Auth", csrf)
                            }
                        },
                        data: form.iframe ? _.extend({
                            todo: "submit",
                            tok: _.has(window, "tref") && !_.isEmpty(window.tref.tok) ? window.tref.tok : ""
                        }, form.serialize()) : JSON.stringify({
                            method: form.method,
                            params: [form.serialize()],
                            id: form.createRandomId(16, 32)
                        })
                    }
                },
                requestComplete: function (resp) {
                    var code, form = this;
                    if (form.iframe)
                        switch (_.parseInt(resp.code)) {
                            case 200:
                                form.responseSuccess();
                                break;
                            case 400:
                                form.makeSnapshot(),
                                    form.responseErrorValidation(resp);
                                break;
                            default:
                                form.responseErrorDefault()
                        }
                    else if (_.isEmpty(resp.error))
                        form.responseSuccess();
                    else
                        switch (code = _.isUndefined(resp.error.code) ? 0 : resp.error.code) {
                            case 400:
                                form.makeSnapshot(),
                                    form.responseErrorValidation(resp);
                                break;
                ...
                validateHandler: function (data) {
                    console.log("fired")
                },
                tooltipHandler: function (event) {
                    var $tooltips = $(this).parents(".smf-group").find(".error-tt");
                    switch (event.type) {
                        case "focusin":
                            $tooltips.show();
                            break;
                ...
                blurHandler: function (event) {
                    var targetData, targetElement, nodeType, value, field = $(this), checkboxes = "";
                    event.preventDefault(),
                        nodeType = (field[0].type + "").toLowerCase(),
                        "checkbox" === nodeType || "radio" === nodeType ? (targetData = field.parents(".smf-list"),
                            targetData.find("input[type=checkbox], input[type=radio]").each(function () {
                                checkboxes += $(this)[0].checked
                            }),
                            value = checkboxes) : (targetData = field,
                                value = field.val()),
                        targetElement = targetData.parents(".smf-field"),
                        targetData.data("original-value") === value ? targetElement.removeClass("error-fixed") : targetElement.addClass("error-fixed")
                },
                validateHandler2: function (data) {
                    console.log("fired 2")
                },
                submitHandler: function (event) {
                    ...
                    $.when(form.validate()).then(function () {
                        form.processing = !0,
                            form.errorsRemoved = !0,
                            form.createRequest.call(form)
                    }, function (data) {
                        form.processing = !1,
                            form.showErrors.call(form, data),
                            form.makeSnapshot()
                    }),
                        event.preventDefault()
                },
                makeSnapshot: function () {
                    var form = this
                        , node = form.getFormNode()
                        , checkboxes = {};
                    return node ? (node.find(".error-fixed").removeClass("error-fixed"),
                        node.find(".has-error input:not([type=checkbox]):not([type=radio]), .has-error textarea").each(function () {
                            var $this = $(this);
                            $this.data("original-value", $this.val() || "")
                        }),
                        node.find(".has-error input[type=checkbox], .has-error input[type=radio]").each(function () {
                            var $this = $(this)
                                , name = $this.attr("name");
                            _.has(checkboxes, name) || (checkboxes[name] = {
                                nodes: [],
                                value: ""
                            }),
                                checkboxes[name].value += $this[0].checked,
                                checkboxes[name].nodes.push($this)
                        }),
                        void _.each(checkboxes, function (group) {
                            group.nodes[0].parents(".smf-list").data("original-value", group.value)
                        })) : form
                },
                attachHandlers: function () {
                    var form = this;
                    return form.on("blur change", ".has-error input, .has-error textarea, .has-error select", form.blurHandler).on("focus blur", ".has-error input, .has-error textarea, .has-error select", form.tooltipHandler).on("submit", _.bind(form.submitHandler, form)),
                        form
                }
            };
            return {
        ...
        define("modules/form/errors/validator", {
            invalidChannels: "#Validator: Invalid channel",
            invalidChannelDef: "#Validator: Invalid channel definition",
            globalChannelCreated: "#Validator: topic is undefined, subscribing to global channel",
            validate: {
                missingType: "#Validator.validate: Missing argument [types]",
                invalidTypeArg: "#Validator.validate: Invalid argument [types]"
            }
        }),
        define("modules/form/events/validator", {
            validated: "validated"
        }),
        define("modules/form/validator", ["app", "jquery", "postal", "modules/form/errors/validator", "modules/form/events/validator"], function (App, $, Postal, Errors, Events) {
            "use strict";
            var Validator = function (channel, topic) {
                var channelDefinition, validator = this, callback = function (data) {
                    validator.validate(data)
                }, delimiter = App.constants.TOPIC_DELIMITER, globalChannel = "Validator" + delimiter + "Global" + delimiter;
                if (validator.topic = _.isEmpty(topic) || !_.isString(topic) ? _.uniqueId(globalChannel) : topic,
                    _.isUndefined(channel))
                    validator.channel = Postal.channel(),
                        validator.subscription = validator.channel.subscribe({
                            topic: validator.topic,
                            callback: callback
                        }),
                        App.debug && console.warn(Errors.globalChannelCreated);
                else {
                    if (!_.isFunction(channel.channel))
                        throw new Error(Errors.invalidChannels);
                    if (channelDefinition = channel.channel(),
                        !_.isEqual(Postal.channel(channelDefinition.channel), channelDefinition))
                        throw new Error(Errors.invalidChannelDef);
                    validator.channel = channel,
                        validator.subscription = validator.channel.subscribe(validator.topic, callback)
                }
                return validator
            };
            return Validator.prototype.validate = function (types) {
                var validator = this
                    , checkboxes = {}
                    , rejects = [];
                if (_.isUndefined(types))
                    throw new Error(Errors.validate.missingType);
                if (!_.isObject(types) || _.isEmpty(types))
                    throw new Error(Errors.validate.invalidTypeArg);
                return _.each(types, function (val, key) {
                    !_.isUndefined(validator.types[key]) && _.isFunction(validator.types[key].check) && (_.each(types[key], function (obj) {
                        var node, nodeType, checkObj = obj.node instanceof $ && !_.isEmpty(obj.node);
                        return node = checkObj ? obj.node[0] : _.isElement(obj.node) ? obj.node : void 0,
                            _.isUndefined(node) ? node : (_.isUndefined(node.type) || (nodeType = (node.type + "").toLowerCase()),
                                void ("checkbox" !== nodeType && "radio" !== nodeType || _.isEmpty(obj.patterns) ? (checkObj = validator.types[key].check({
                                    patterns: obj.patterns,
                                    value: node.value
                                }),
                                    _.isEmpty(checkObj) || rejects.push({
                                        node: obj.node,
                                        rejected: checkObj
                                    })) : (_.has(checkboxes, node.name) || (checkboxes[node.name] = {
                                        patterns: obj.patterns,
                                        value: []
                                    }),
                                        checkboxes[node.name].value.push(obj.node))))
                    }),
                        _.each(checkboxes, function (group) {
                            var checkObj = validator.types.checkboxes.check({
                                patterns: group.patterns,
                                value: group.value
                            });
                            rejects = rejects.concat(checkObj)
                        }))
                }),
                    validator.channel.publish(Events.validated, rejects.length ? rejects : !1)
            }
                ,
                Validator.prototype.types = {
                    patterns: {
                        check: function (obj) {
                            if (!_.isUndefined(obj) && !_.isUndefined(obj.value)) {
                                var patterns = {};
                                return _.each(obj.patterns ? obj.patterns : {}, function (val, key) {
                                    var test = val.test(obj.value);
                                    test || (patterns[key] = test)
                                }),
                                    patterns
                            }
                        }
                    ...
                    checkboxes: {
                        check: function (obj) {
                            var patterns = {}
                                , rejected = [];
                            return _.isUndefined(obj) || _.isUndefined(obj.value) || !_.isArray(obj.value) ? void 0 : (_.each(obj.patterns ? obj.patterns : {}, function (func, key) {
                                var checked = _.reduce(obj.value, function (acc, node) {
                                    return node[0].checked && (acc += 1),
                                        acc
                                }, 0)
                                    , test = func(checked);
                                test || (patterns[key] = test)
                            }),
                                _.isEmpty(patterns) || (patterns.required = !1),
        ...
        define("modules/form/form", ["app", "jquery", "postal", "channels", "modules/form/events/form", "modules/form/errors/form", "modules/form/regex/form", "modules/form/ui", "modules/form/validator", "modules/form/events/validator"], function (App, $, Postal, Channels, Events, Errors, RegEx, UI, Validator, ValidatorEvents) {
            "use strict";
            var Form = function Form(data) {
                if (!data)
                    throw new Error("#Form.constructor: Missing argument [data]");
                var form = this
                    , has = "hasOwnProperty";
                return form instanceof Form ? (form.structure = data.installStructure(),
                    form.instanceName = data.name,
                    _.merge(form, _.defaults(form.structure.getConfig(), {
                        html: null,
                        deferred: null,
                        processing: null,
                        endpoint: "./",
                    ...
                    form.channel = data.installChannels(),
                    form.fields = form.validation[has]("fields") ? form.validation.fields.join(",") : form.elements,
                    form.patterns = form.filterPatterns(form.validation[has]("patterns") ? form.validation.patterns : []),
                    _.isEmpty(form.validation) || new Validator(form.channel, Events.submit),
                    UI.installTo(form),
                    form) : new Form(data)
            };
            return Form.prototype.assignPatterns = function (field) {
                var form = this
                    , obj = {
                        node: $(field)
                    }
                    , validator = (obj.node.data("sm-validator") || "").split(",")
                    , patterns = _.reduce(validator, function (accum, entry) {
                        return entry = App.utils.trim(entry),
                            _.each(form.patterns, function (val, i) {
                                form.patterns[i][entry] && (accum[entry] = form.patterns[i][entry])
                            }),
                            accum
                    }, {});
                return _.keys(patterns).length ? obj.patterns = patterns : void 0,
                    obj
            }
                ,
                Form.prototype.bindHandler = function (type, args) {
                    var form = this
                        , html = form.html;
                    if (_.isEmpty(html))
                        throw new Error("#Form." + type + ": Form.html is null or undefined.");
                    return $.fn[type].apply($(html.node), args),
                        form
                }
                ,
                Form.prototype.buildMeta = function (selector) {
                    var form = this
                        , element = $(selector).unbind()
                        , fields = element.find(form.elements);
                    return {
                        node: element,
                        fields: fields,
                        validation: {
                            patterns: _.map(fields, form.assignPatterns, form)
                        }
                    }
                }
                ,
                Form.prototype.destroy = function () {
                    ...
                    return form.html && form.destroyDom(),
                        form = void 0,
                        Channels.appPublish("destroy", {
                            name: name
                        }),
                        form
                }
                ,
                Form.prototype.destroyDom = function () {
                    var form = this;
                    return form.html.node.empty(),
                        form.html = null,
                        form
                }
                ,
                Form.prototype.dom = function (selector) {
                    var form = this
                        , html = $(selector);
                    if (_.isUndefined(selector))
                        throw new Error("#Form.dom: Missing argument [selector]");
                    if (_.isEmpty(html))
                        throw new Error("#Form.dom: Invalid argument [selector]");
                    if (!html.is("form"))
                        throw new Error("#Form.dom: Invalid HTML Element type.");
                    if (_.isEmpty($(form.elements, html)))
                        throw new Error("#Form.dom: Form has no fields, please provide some.");
                    return form.html = form.buildMeta(html),
                        form
                }
                ,
                Form.prototype.filterPatterns = function (patterns) {
                    return _.isArray(patterns) && patterns.length ? _.map(_.filter(patterns, function (val, index) {
                        return void 0 !== RegEx[val]
                    }), function (val) {
                        var obj = {};
                        return obj[val] = RegEx[val],
                            obj
                    }) : []
                }
                ,
                Form.prototype.init = function () {
                    var action, form = this;
                    return form.channel.subscribe(ValidatorEvents.validated, function (data) {
                        form.validationHandler.call(form, data)
                    }),
                        form.dom(form.structure.getMain$El()).attachHandlers(),
                        action = _.isEmpty(form.html) ? "" : form.html.node.attr("action"),
                        _.isEqual(form.endpoint, "./") && action && (form.endpoint = action),
                        form
                }
                ,
                Form.prototype.off = function () {
                    var form = this;
                    return form.bindHandler("off", arguments),
                        form
                }
                ,
                Form.prototype.on = function () {
                    var form = this;
                    return form.bindHandler("on", arguments),
                        form
                }
                ,
                Form.prototype.processValidation = function (data) {
                    var postObj = {}
                        , required = []
                        , invalid = [];
                    return _.isUndefined(data) || _.isEmpty(data) ? void 0 : (_.each(data, function (obj) {
                        _.isUndefined(obj) || _.isUndefined(obj.rejected) && _.isUndefined(obj.node) || (_.isUndefined(obj.rejected.required) || obj.rejected.required !== !1 ? _.isEmpty($(obj.node).val()) || _.isEmpty(obj.rejected) || _.some(obj.rejected, Boolean) || invalid.push(obj.node) : required.push(obj.node))
                    }),
                        invalid.length && (postObj.invalid = invalid),
                        required.length && (postObj.required = required),
                        _.isEmpty(postObj) ? void 0 : postObj)
                }
                ,
                Form.prototype.serialize = function () {
                    var form = this;
                    return _.reduce(form.zip("fields") || {}, function (accum, val) {
                        var valType = (val.type + "").toLocaleLowerCase();
                        return "checkbox" === valType || "radio" === valType ? (_.has(accum, val.name) || (accum[val.name] = []),
                            val.checked && accum[val.name].push(val.value)) : "file" !== valType && (accum[val.name] = val.value),
                            accum
                    }, {})
                }
                ,
                Form.prototype.submit = function () {
                    var form = this
                        ...
                        , html = form.html;
                    if (_.isEmpty(html))
                        throw new Error("#Form.submit: Form.html is null or undefined.");
                    return args.length ? form.bindHandler("submit", args) : html.node.submit(),
                        form
                }
                ,
                Form.prototype.validate = function (callback) {
                    var form = this
                        , cb = callback ? function (data) {
                            callback(form.validationHandler(data))
                        }
                            : void 0;
                    return callback ? form.channel.subscribe(ValidatorEvents.validated, cb).disposeAfter(1) : form.deferred = new $.Deferred,
                        form.channel.publish(Events.submit, form.zip("validation")),
                        form.deferred ? form.deferred.promise() : form
                }
                ,
                Form.prototype.validationHandler = function (data) {
                    var form = this
                        , processData = form.processValidation(data);
                    processData ? (form.channel.publish(Events.invalid, processData),
                        form.deferred && form.deferred.reject(processData)) : (form.channel.publish(Events.valid),
                            form.deferred && form.deferred.resolve())
                }
                ,
                Form.prototype.zip = function (prop) {
                    var form = this
                        , html = form.html;
                    if (_.isEmpty(html))
                        throw new Error("#Form.zip: Form.html is null or undefined.");
                    return html[prop] ? html[prop] : []
                }
                ,
                Form
        }),
        define("modules/uploadfield/ui", ["app", "customerror", "i18n"], function (App, customError, i18n) {
            var CLASS_CLOAK = "smf-cloak"
                , CLASS_ERROR = "text-error"
                , CLASS_FORM_GROUP = "smf-group"
                , CLASS_FORM_ERROR = "has-error"
                , TEXT = {
                    empty: {
                        text: i18n.safeTranslate("Form_Upload_Field_Empty", "No file uploaded"),
                        error: !1
                    },
                    required: {
                        text: i18n.safeTranslate("Form_Required_Message", "Required field"),
                        error: !0
                    },
                    sizeError: {
                        text: i18n.safeTranslate("Form_Upload_Field_Size_Error", "File is too big"),
                        error: !0
                    }
                }
                , ELEMENTS = {
                ...
                , STATES = {
                    initial: ["status", "nfo", "add"],
                    selected: ["name", "remove"]
                }
                , UploadFieldError = customError("UploadField")
                , UI = {
                    setupUI: function () {
                        var uploadfield = this;
                        return _.each(ELEMENTS, _.bind(uploadfield.linkElement, uploadfield)),
                            _.each(STATES, _.bind(uploadfield.linkState, uploadfield)),
                            uploadfield.switchState("initial").setStatusText("empty"),
                            uploadfield.ui.getMain$El().removeClass(CLASS_CLOAK),
                            uploadfield
                    },
                    linkElement: function (name, key) {
                        var uploadfield = this
                            , $element = uploadfield.ui.get$El(name);
                        if (_.isEmpty($element))
                            throw new UploadFieldError("Missing UI element.");
                        return uploadfield.$element[key] = $element,
                            uploadfield
                    },
                    linkState: function (elements, key) {
                        var uploadfield = this
                            , $elements = _.pick(uploadfield.$element, elements);
                        if (_.isEmpty($elements) || elements.length !== _.toArray($elements).length)
                            throw new UploadFieldError("Requested elements can't be added to the state.");
                        return uploadfield.$state[key] = $elements,
                            uploadfield
                    },
                    switchState: function (name) {
                        var uploadfield = this
                            , active = uploadfield.$state[name]
                            , other = _.reject(uploadfield.$state, function (val, key) {
                                return key === name
                            });
                        if (_.isEmpty(active))
                            throw new UploadFieldError("UI state does not exist.");
                        return _.each(other, _.bind(uploadfield.hideElements, uploadfield)),
                            uploadfield.showElements(active),
                            uploadfield
                    },
                    showElements: function (elements) {
                        var uploadfield = this;
                        return _.invoke(elements, "show"),
                            uploadfield
                    },
                    hideElements: function (elements) {
                        var uploadfield = this;
                        return _.invoke(elements, "hide"),
                            uploadfield
                    },
                    setStatusText: function (key, appendix) {
                        var message, uploadfield = this, $text = uploadfield.$element.status, additionalContent = _.isUndefined(appendix) ? "" : appendix + "";
                        if (!_.has(TEXT, key) || !_.isPlainObject(TEXT[key]))
                            throw new UploadFieldError("Status message does not exists.");
                        return message = TEXT[key],
                            message.error ? $text.addClass(CLASS_ERROR) : $text.removeClass(CLASS_ERROR),
                            $text.text(message.text + additionalContent),
                            uploadfield
                    },
                    setFileName: function (path) {
                        ...
                        return uploadfield.$element.name.text(fileName),
                            uploadfield
                    },
                    hasError: function () {
                        var uploadfield = this
                            , parentGroup = uploadfield.ui.getMain$El().parents("." + CLASS_FORM_GROUP);
                        return parentGroup.length ? parentGroup.hasClass(CLASS_FORM_ERROR) : !1
                    }
                };
            return {
                installTo: function (obj) {
        ...
        define("modules/uploadfield/uploadfield", ["app", "channels", "modules/uploadfield/ui", "modules/form/events/form", "customerror"], function (App, Channels, UI, FormEvents, customError) {
            function UploadField(data) {
                var instance = {}
                    , defaults = {
                        parentForm: $(data.el).parents("form").data(App.utils.createAttrName(App.constants.INSTANCE))
                    };
                if (_.isEmpty(defaults.parentForm) || !_.isString(defaults.parentForm))
                    throw new UploadFieldError("Field doesn't have parent Form element.");
                return instance.init = function () {
                    instance.ui = data.installStructure(),
                        _.merge(instance, _.defaults(instance.ui.getConfig(), defaults)),
                        UI.installTo(instance),
                        instance.setupUI(),
                        UploadField.controller(instance),
                        instance.init = null
                }
                    ,
                    instance
            }
            var UploadFieldError = customError("UploadField");
            return UploadField.controller = function (uploadfield) {
                var formSubscribe = Channels.limitSubscription("form", uploadfield.parentForm);
                uploadfield.$element.file.change(function () {
                    uploadfield.switchState("selected").setFileName($(this).val())
                }),
                    "label" !== (uploadfield.$element.add[0].tagName + "").toLowerCase() && uploadfield.$element.add.click(function () {
                        uploadfield.$element.file.click()
                    }),
                    uploadfield.$element.remove.click(function () {
                        uploadfield.$element.file.val("").blur(),
                            uploadfield.setStatusText("empty").switchState("initial")
                    }),
                    formSubscribe(FormEvents.checkUploadFields, _.bind(function () {
                        uploadfield.hasError() ? _.isEmpty(uploadfield.$element.file.val()) ? uploadfield.setStatusText("required") : uploadfield.setStatusText("sizeError", " - " + uploadfield.$element.name.text()).switchState("initial") : uploadfield.setStatusText("empty")
                    }), uploadfield)
            }
                ,
                UploadField
        ...
        requirejs.config({
            ...
            paths: {
                ...
                "class": "../libs/Class.js/Class",
                jquery: "../libs/jquery/jquery",
                "jquery-iframe-transport": "../libs/jquery.iframe-transport/jquery.iframe-transport",
                postal: "../libs/postal.js/postal",
        ...
        define("preview", ["i18n"], function (i18n) {
            "use strict";
            var _getParameterByName = function (name) {
                ...
                , _previewEnabled = function () {
                    var curLoc = window.location.toString()
                        , previewExists = null != curLoc.match("preview=Y")
                        , draftCookie = (null != curLoc.match("drafttok="),
                            -1 !== document.cookie.indexOf("in_draft_mode"))
                        , drafttok = _getParameterByName("drafttok");
                    return previewExists && (draftCookie || !drafttok)
                }
                , showExitPreviewButton = function () {
                    var editLoc, editDiv, editA, buttonText;
                    if (_previewEnabled()) {
                        editLoc = window.location.toString().replace(/\?.*/, ""),
                            editDiv = document.createElement("div"),
                            editA = document.createElement("a");
                        var att = document.createAttribute("id");
                        att.value = "preview_button",
                            editA.setAttributeNode(att),
                            buttonText = i18n.safeTranslate("Preview_Exit_Button", "Exit preview"),
                            editA.href = editLoc,
                            editDiv.className = "editmode",
                            editA.appendChild(document.createTextNode(buttonText)),
                            editDiv.appendChild(editA),
                            $(".pageOffset").before(editDiv)
                    }
                };
            return {
                showExitPreviewButton: showExitPreviewButton
            }
        }),
        require(["config"], function () {
            requirejs(["app", "jquery", "i18n", "preview"], function (App, $, i18n, preview) {
                window.App = App,
                    _.has(window, "EXPOSE_JQUERY") && window.EXPOSE_JQUERY === !0 && (window.$ = $,
                        window.jQuery = $),
                    $(document).ready(function () {
                        i18n.loadFromPage(),
                            i18n.switchLang($("html").attr("lang")),
                            App.init()
                    })
            })
        }),
